...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/pipelines/{pipeline_identifier}/branch-sequences/branch".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Delete Branch Sequence
     ...
     Deletes the branch sequence record for a specific branch and repository combination. The repository
    URL will be normalized internally.
