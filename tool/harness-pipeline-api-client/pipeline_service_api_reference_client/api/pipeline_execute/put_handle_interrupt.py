...
from ...models.put_handle_interrupt_interrupt_type import (
...
def _get_kwargs(
    ...
    *,
    ...
    interrupt_type: PutHandleInterruptInterruptType,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/pipeline/execute/interrupt/{plan_execution_id}".format(
