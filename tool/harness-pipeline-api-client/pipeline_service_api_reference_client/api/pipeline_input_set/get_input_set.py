...
from ...models.response_dto_input_set_response import ResponseDTOInputSetResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOInputSetResponse:
    ...
    response_default = ResponseDTOInputSetResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOInputSetResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    get_default_from_other_repo: bool | Unset = UNSET,
    load_from_cache: str | Unset = "false",
) -> Error | Failure | ResponseDTOInputSetResponse | None:
    """Fetch an Input Set
