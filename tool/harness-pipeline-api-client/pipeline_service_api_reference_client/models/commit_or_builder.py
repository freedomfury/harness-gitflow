...
if TYPE_CHECKING:
    ...
    from ..models.commit_or_builder_all_fields import CommitOrBuilderAllFields
...
T = TypeVar("T", bound="CommitOrBuilder")


@_attrs_define
class CommitOrBuilder:
    """
    Attributes:
        link (str | Unset):
        sha (str | Unset):
        ...
        all_fields (CommitOrBuilderAllFields | Unset):
    ...
    all_fields: CommitOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = CommitOrBuilderAllFields.from_dict(_all_fields)
        ...
        commit_or_builder.additional_properties = d
        return commit_or_builder
