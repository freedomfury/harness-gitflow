...
if TYPE_CHECKING:
    ...
    from ..models.message_options_or_builder_all_fields import MessageOptionsOrBuilderAllFields
...
T = TypeVar("T", bound="MessageOptionsOrBuilder")
...
class MessageOptionsOrBuilder:
    ...
    Attributes:
        ...
        all_fields (MessageOptionsOrBuilderAllFields | Unset):
    ...
    all_fields: MessageOptionsOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = MessageOptionsOrBuilderAllFields.from_dict(_all_fields)
        ...
        message_options_or_builder = cls(
            features=features,
        ...
        message_options_or_builder.additional_properties = d
        return message_options_or_builder
