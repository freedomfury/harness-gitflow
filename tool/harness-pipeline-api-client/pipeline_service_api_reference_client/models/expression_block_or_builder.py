...
if TYPE_CHECKING:
    ...
    from ..models.expression_block_or_builder_all_fields import ExpressionBlockOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="ExpressionBlockOrBuilder")


@_attrs_define
class ExpressionBlockOrBuilder:
    """
    Attributes:
        ...
        all_fields (ExpressionBlockOrBuilderAllFields | Unset):
    ...
    all_fields: ExpressionBlockOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ExpressionBlockOrBuilderAllFields.from_dict(_all_fields)
        ...
        expression_block_or_builder = cls(
        ...
        expression_block_or_builder.additional_properties = d
        return expression_block_or_builder
