...
if TYPE_CHECKING:
    ...
    from ..models.pipeline_execution_identifier_summary import PipelineExecutionIdentifierSummary
    from ..models.sort import Sort


T = TypeVar("T", bound="PagePipelineExecutionIdentifierSummary")


@_attrs_define
class PagePipelineExecutionIdentifierSummary:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[PipelineExecutionIdentifierSummary] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[PipelineExecutionIdentifierSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = PipelineExecutionIdentifierSummary.from_dict(content_item_data)
        ...
        page_pipeline_execution_identifier_summary = cls(
        ...
        page_pipeline_execution_identifier_summary.additional_properties = d
        return page_pipeline_execution_identifier_summary
