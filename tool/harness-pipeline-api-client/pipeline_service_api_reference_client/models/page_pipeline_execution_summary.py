...
T = TypeVar("T", bound="PagePipelineExecutionSummary")


@_attrs_define
class PagePipelineExecutionSummary:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[PipelineExecutionSummary] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[PipelineExecutionSummary] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = PipelineExecutionSummary.from_dict(content_item_data)
        ...
        page_pipeline_execution_summary = cls(
        ...
        page_pipeline_execution_summary.additional_properties = d
        return page_pipeline_execution_summary
