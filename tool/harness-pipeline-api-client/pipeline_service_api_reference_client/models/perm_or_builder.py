...
if TYPE_CHECKING:
    ...
    from ..models.perm_or_builder_all_fields import PermOrBuilderAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="PermOrBuilder")
...
class PermOrBuilder:
    ...
    Attributes:
        ...
        push (bool | Unset):
        pull (bool | Unset):
        all_fields (PermOrBuilderAllFields | Unset):
    ...
    all_fields: PermOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = PermOrBuilderAllFields.from_dict(_all_fields)
        ...
        perm_or_builder.additional_properties = d
        return perm_or_builder
