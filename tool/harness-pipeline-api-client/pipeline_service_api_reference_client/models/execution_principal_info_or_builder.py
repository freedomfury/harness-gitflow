...
from ..models.execution_principal_info_or_builder_principal_type import (
    ExecutionPrincipalInfoOrBuilderPrincipalType,
    check_execution_principal_info_or_builder_principal_type,
)
...
if TYPE_CHECKING:
    ...
    from ..models.execution_principal_info_or_builder_all_fields import ExecutionPrincipalInfoOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="ExecutionPrincipalInfoOrBuilder")


@_attrs_define
class ExecutionPrincipalInfoOrBuilder:
    """
    Attributes:
        principal (str | Unset):
        principal_bytes (ByteString | Unset):
        principal_type_value (int | Unset):
        principal_type (ExecutionPrincipalInfoOrBuilderPrincipalType | Unset):
        should_validate_rbac (bool | Unset):
        all_fields (ExecutionPrincipalInfoOrBuilderAllFields | Unset):
    ...
    principal_type: ExecutionPrincipalInfoOrBuilderPrincipalType | Unset = UNSET
    should_validate_rbac: bool | Unset = UNSET
    all_fields: ExecutionPrincipalInfoOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_principal_type, Unset):
            ...
            principal_type = check_execution_principal_info_or_builder_principal_type(_principal_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ExecutionPrincipalInfoOrBuilderAllFields.from_dict(_all_fields)
        ...
        execution_principal_info_or_builder = cls(
            principal=principal,
        ...
        execution_principal_info_or_builder.additional_properties = d
        return execution_principal_info_or_builder
