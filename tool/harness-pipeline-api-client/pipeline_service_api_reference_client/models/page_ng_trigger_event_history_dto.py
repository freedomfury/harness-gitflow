...
if TYPE_CHECKING:
    from ..models.ng_trigger_event_history_dto import NGTriggerEventHistoryDTO
    from ..models.pageable import Pageable
    from ..models.sort import Sort


T = TypeVar("T", bound="PageNGTriggerEventHistoryDTO")


@_attrs_define
class PageNGTriggerEventHistoryDTO:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[NGTriggerEventHistoryDTO] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[NGTriggerEventHistoryDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = NGTriggerEventHistoryDTO.from_dict(content_item_data)
        ...
        page_ng_trigger_event_history_dto = cls(
        ...
        page_ng_trigger_event_history_dto.additional_properties = d
        return page_ng_trigger_event_history_dto
