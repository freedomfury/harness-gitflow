...
T = TypeVar("T", bound="ResponseMessageExceptionStackTraceItem")


@_attrs_define
class ResponseMessageExceptionStackTraceItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        response_message_exception_stack_trace_item = cls(
        ...
        response_message_exception_stack_trace_item.additional_properties = d
        return response_message_exception_stack_trace_item
