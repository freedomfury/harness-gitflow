...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_integer_meta_data import RestResponseIntegerMetaData


T = TypeVar("T", bound="RestResponseInteger")


@_attrs_define
class RestResponseInteger:
    """
    Attributes:
        meta_data (RestResponseIntegerMetaData | Unset):
        resource (int | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseIntegerMetaData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseIntegerMetaData.from_dict(_meta_data)
        ...
        rest_response_integer = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_integer.additional_properties = d
        return rest_response_integer
