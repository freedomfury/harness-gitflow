...
NGTriggerEventHistoryBaseDTOFinalStatus = Literal[
...
NG_TRIGGER_EVENT_HISTORY_BASE_DTO_FINAL_STATUS_VALUES: set[NGTriggerEventHistoryBaseDTOFinalStatus] = {
    "ALL_MAPPED_TRIGGER_FAILED_VALIDATION_FOR_POLLING_EVENT",
    "EXCEPTION_WHILE_PROCESSING",
    "FAILED_TO_FETCH_PR_DETAILS",
    "HARNESS_ARTIFACT_REGISTRY_WEBHOOK_NOT_EXECUTED",
...
def check_ng_trigger_event_history_base_dto_final_status(value: str) -> NGTriggerEventHistoryBaseDTOFinalStatus:
    if value in NG_TRIGGER_EVENT_HISTORY_BASE_DTO_FINAL_STATUS_VALUES:
        return cast(NGTriggerEventHistoryBaseDTOFinalStatus, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {NG_TRIGGER_EVENT_HISTORY_BASE_DTO_FINAL_STATUS_VALUES!r}"
    )
