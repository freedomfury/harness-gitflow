...
if TYPE_CHECKING:
    ...
    from ..models.enum_options_all_fields import EnumOptionsAllFields
    from ..models.enum_options_all_fields_raw import EnumOptionsAllFieldsRaw
    from ..models.feature_set import FeatureSet
    from ..models.feature_set_or_builder import FeatureSetOrBuilder
    from ..models.parser_enum_options import ParserEnumOptions
...
class EnumOptions:
    ...
    Attributes:
        ...
        default_instance_for_type (EnumOptions | Unset):
        parser_for_type (ParserEnumOptions | Unset):
        ...
        allow_alias (bool | Unset):
        all_fields (EnumOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (EnumOptionsAllFieldsRaw | Unset):
    ...
    default_instance_for_type: EnumOptions | Unset = UNSET
    parser_for_type: ParserEnumOptions | Unset = UNSET
    ...
    allow_alias: bool | Unset = UNSET
    all_fields: EnumOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: EnumOptionsAllFieldsRaw | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if allow_alias is not UNSET:
            field_dict["allowAlias"] = allow_alias
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = EnumOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserEnumOptions.from_dict(_parser_for_type)
        ...
        allow_alias = d.pop("allowAlias", UNSET)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = EnumOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = EnumOptionsAllFieldsRaw.from_dict(_all_fields_raw)
        ...
        enum_options.additional_properties = d
        return enum_options
