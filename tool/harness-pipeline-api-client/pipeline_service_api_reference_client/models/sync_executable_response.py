...
if TYPE_CHECKING:
    ...
    from ..models.parser_sync_executable_response import ParserSyncExecutableResponse
    from ..models.sync_executable_response_all_fields import SyncExecutableResponseAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="SyncExecutableResponse")


@_attrs_define
class SyncExecutableResponse:
    """
    Attributes:
        ...
        default_instance_for_type (SyncExecutableResponse | Unset):
        parser_for_type (ParserSyncExecutableResponse | Unset):
        serialized_size (int | Unset):
        all_fields (SyncExecutableResponseAllFields | Unset):
    ...
    default_instance_for_type: SyncExecutableResponse | Unset = UNSET
    parser_for_type: ParserSyncExecutableResponse | Unset = UNSET
    serialized_size: int | Unset = UNSET
    all_fields: SyncExecutableResponseAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = SyncExecutableResponse.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserSyncExecutableResponse.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = SyncExecutableResponseAllFields.from_dict(_all_fields)
        ...
        sync_executable_response.additional_properties = d
        return sync_executable_response
