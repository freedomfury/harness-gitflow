...
if TYPE_CHECKING:
    from ..models.input_set_list_response import InputSetListResponse


T = TypeVar("T", bound="PageResponseInputSetListResponse")


@_attrs_define
class PageResponseInputSetListResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[InputSetListResponse] | Unset):
    ...
    content: list[InputSetListResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = InputSetListResponse.from_dict(content_item_data)
        ...
        page_response_input_set_list_response = cls(
        ...
        page_response_input_set_list_response.additional_properties = d
        return page_response_input_set_list_response
