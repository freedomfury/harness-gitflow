...
from ..models.file_options_optimize_for import FileOptionsOptimizeFor, check_file_options_optimize_for
...
if TYPE_CHECKING:
    ...
    from ..models.file_options_all_fields import FileOptionsAllFields
    from ..models.file_options_all_fields_raw import FileOptionsAllFieldsRaw
    from ..models.parser_file_options import ParserFileOptions
...
class FileOptions:
    ...
    Attributes:
        ...
        default_instance_for_type (FileOptions | Unset):
        java_string_check_utf_8 (bool | Unset):
        parser_for_type (ParserFileOptions | Unset):
        ...
        optimize_for (FileOptionsOptimizeFor | Unset):
        ...
        all_fields (FileOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (FileOptionsAllFieldsRaw | Unset):
    ...
    default_instance_for_type: FileOptions | Unset = UNSET
    java_string_check_utf_8: bool | Unset = UNSET
    parser_for_type: ParserFileOptions | Unset = UNSET
    ...
    optimize_for: FileOptionsOptimizeFor | Unset = UNSET
    ...
    all_fields: FileOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: FileOptionsAllFieldsRaw | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = FileOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserFileOptions.from_dict(_parser_for_type)
        ...
        if isinstance(_optimize_for, Unset):
            ...
            optimize_for = check_file_options_optimize_for(_optimize_for)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = FileOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = FileOptionsAllFieldsRaw.from_dict(_all_fields_raw)
        ...
        file_options.additional_properties = d
        return file_options
