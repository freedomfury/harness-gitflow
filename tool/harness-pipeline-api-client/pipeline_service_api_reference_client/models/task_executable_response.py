...
from ..models.task_executable_response_task_category import (
    TaskExecutableResponseTaskCategory,
    check_task_executable_response_task_category,
)
...
if TYPE_CHECKING:
    ...
    from ..models.parser_task_executable_response import ParserTaskExecutableResponse
    from ..models.task_executable_response_all_fields import TaskExecutableResponseAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="TaskExecutableResponse")
...
class TaskExecutableResponse:
    ...
    Attributes:
        ...
        task_category (TaskExecutableResponseTaskCategory | Unset):
        ...
        default_instance_for_type (TaskExecutableResponse | Unset):
        parser_for_type (ParserTaskExecutableResponse | Unset):
        serialized_size (int | Unset):
        task_id (str | Unset):
        task_name (str | Unset):
        all_fields (TaskExecutableResponseAllFields | Unset):
    ...
    task_category: TaskExecutableResponseTaskCategory | Unset = UNSET
    ...
    default_instance_for_type: TaskExecutableResponse | Unset = UNSET
    parser_for_type: ParserTaskExecutableResponse | Unset = UNSET
    serialized_size: int | Unset = UNSET
    task_id: str | Unset = UNSET
    task_name: str | Unset = UNSET
    all_fields: TaskExecutableResponseAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_task_category, Unset):
            ...
            task_category = check_task_executable_response_task_category(_task_category)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = TaskExecutableResponse.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserTaskExecutableResponse.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = TaskExecutableResponseAllFields.from_dict(_all_fields)
        ...
        task_executable_response.additional_properties = d
        return task_executable_response
