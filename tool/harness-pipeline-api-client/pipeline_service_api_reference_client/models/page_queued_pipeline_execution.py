...
if TYPE_CHECKING:
    ...
    from ..models.queued_pipeline_execution import QueuedPipelineExecution
    from ..models.sort import Sort


T = TypeVar("T", bound="PageQueuedPipelineExecution")


@_attrs_define
class PageQueuedPipelineExecution:
    """Paginated list of queued pipeline executions
    ...
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[QueuedPipelineExecution] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[QueuedPipelineExecution] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = QueuedPipelineExecution.from_dict(content_item_data)
        ...
        page_queued_pipeline_execution = cls(
        ...
        page_queued_pipeline_execution.additional_properties = d
        return page_queued_pipeline_execution
