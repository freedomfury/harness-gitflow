...
from ..models.rerun_info_prev_trigger_type import RerunInfoPrevTriggerType, check_rerun_info_prev_trigger_type
from ..models.rerun_info_root_trigger_type import RerunInfoRootTriggerType, check_rerun_info_root_trigger_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.byte_string import ByteString
    from ..models.descriptor import Descriptor
    from ..models.parser_rerun_info import ParserRerunInfo
    from ..models.rerun_info_all_fields import RerunInfoAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="RerunInfo")
...
class RerunInfo:
    ...
    Attributes:
        ...
        root_trigger_type (RerunInfoRootTriggerType | Unset):
        ...
        prev_trigger_type (RerunInfoPrevTriggerType | Unset):
        initialized (bool | Unset):
        root_execution_id (str | Unset):
        default_instance_for_type (RerunInfo | Unset):
        parser_for_type (ParserRerunInfo | Unset):
        serialized_size (int | Unset):
        prev_execution_id (str | Unset):
        all_fields (RerunInfoAllFields | Unset):
    ...
    root_trigger_type: RerunInfoRootTriggerType | Unset = UNSET
    ...
    prev_trigger_type: RerunInfoPrevTriggerType | Unset = UNSET
    initialized: bool | Unset = UNSET
    root_execution_id: str | Unset = UNSET
    default_instance_for_type: RerunInfo | Unset = UNSET
    parser_for_type: ParserRerunInfo | Unset = UNSET
    serialized_size: int | Unset = UNSET
    prev_execution_id: str | Unset = UNSET
    all_fields: RerunInfoAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_root_trigger_type, Unset):
            ...
            root_trigger_type = check_rerun_info_root_trigger_type(_root_trigger_type)
        ...
        if isinstance(_prev_trigger_type, Unset):
            ...
            prev_trigger_type = check_rerun_info_prev_trigger_type(_prev_trigger_type)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = RerunInfo.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserRerunInfo.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = RerunInfoAllFields.from_dict(_all_fields)
        ...
        rerun_info.additional_properties = d
        return rerun_info
