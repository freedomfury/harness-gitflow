...
from ..models.tag_hook_action import TagHookAction, check_tag_hook_action
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.descriptor import Descriptor
    from ..models.parser_tag_hook import ParserTagHook
    ...
    from ..models.tag_hook_all_fields import TagHookAllFields
    from ..models.unknown_field_set import UnknownFieldSet
    from ..models.user import User
    from ..models.user_or_builder import UserOrBuilder


T = TypeVar("T", bound="TagHook")
...
class TagHook:
    ...
    Attributes:
        ...
        action (TagHookAction | Unset):
        default_instance_for_type (TagHook | Unset):
        parser_for_type (ParserTagHook | Unset):
        serialized_size (int | Unset):
        repo (Repository | Unset):
        all_fields (TagHookAllFields | Unset):
    ...
    action: TagHookAction | Unset = UNSET
    default_instance_for_type: TagHook | Unset = UNSET
    parser_for_type: ParserTagHook | Unset = UNSET
    serialized_size: int | Unset = UNSET
    repo: Repository | Unset = UNSET
    all_fields: TagHookAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_action, Unset):
            ...
            action = check_tag_hook_action(_action)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = TagHook.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserTagHook.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = TagHookAllFields.from_dict(_all_fields)
        ...
        tag_hook.additional_properties = d
        return tag_hook
