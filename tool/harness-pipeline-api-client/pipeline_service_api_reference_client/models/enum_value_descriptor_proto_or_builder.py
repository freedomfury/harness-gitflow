...
if TYPE_CHECKING:
    ...
    from ..models.enum_value_descriptor_proto_or_builder_all_fields import EnumValueDescriptorProtoOrBuilderAllFields
...
T = TypeVar("T", bound="EnumValueDescriptorProtoOrBuilder")
...
class EnumValueDescriptorProtoOrBuilder:
    ...
    Attributes:
        ...
        all_fields (EnumValueDescriptorProtoOrBuilderAllFields | Unset):
    ...
    all_fields: EnumValueDescriptorProtoOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.byte_string import ByteString
        from ..models.descriptor import Descriptor
        from ..models.enum_value_descriptor_proto_or_builder_all_fields import (
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = EnumValueDescriptorProtoOrBuilderAllFields.from_dict(_all_fields)
        ...
        enum_value_descriptor_proto_or_builder = cls(
            name=name,
            number=number,
            options=options,
        ...
        enum_value_descriptor_proto_or_builder.additional_properties = d
        return enum_value_descriptor_proto_or_builder
