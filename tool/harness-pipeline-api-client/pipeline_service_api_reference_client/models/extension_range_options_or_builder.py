...
from ..models.extension_range_options_or_builder_verification import (
    ExtensionRangeOptionsOrBuilderVerification,
    check_extension_range_options_or_builder_verification,
)
...
if TYPE_CHECKING:
    ...
    from ..models.extension_range_options_or_builder_all_fields import ExtensionRangeOptionsOrBuilderAllFields
...
T = TypeVar("T", bound="ExtensionRangeOptionsOrBuilder")
...
class ExtensionRangeOptionsOrBuilder:
    ...
    Attributes:
        ...
        verification (ExtensionRangeOptionsOrBuilderVerification | Unset):
        declaration_list (list[Declaration] | Unset):
        default_instance_for_type (Message | Unset):
        all_fields (ExtensionRangeOptionsOrBuilderAllFields | Unset):
    ...
    verification: ExtensionRangeOptionsOrBuilderVerification | Unset = UNSET
    declaration_list: list[Declaration] | Unset = UNSET
    default_instance_for_type: Message | Unset = UNSET
    all_fields: ExtensionRangeOptionsOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_verification, Unset):
            ...
            verification = check_extension_range_options_or_builder_verification(_verification)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ExtensionRangeOptionsOrBuilderAllFields.from_dict(_all_fields)
        ...
        extension_range_options_or_builder = cls(
            features=features,
        ...
        extension_range_options_or_builder.additional_properties = d
        return extension_range_options_or_builder
