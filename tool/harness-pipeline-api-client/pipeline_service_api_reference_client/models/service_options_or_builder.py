...
if TYPE_CHECKING:
    ...
    from ..models.service_options_or_builder_all_fields import ServiceOptionsOrBuilderAllFields
...
T = TypeVar("T", bound="ServiceOptionsOrBuilder")
...
class ServiceOptionsOrBuilder:
    ...
    Attributes:
        ...
        all_fields (ServiceOptionsOrBuilderAllFields | Unset):
    ...
    all_fields: ServiceOptionsOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ServiceOptionsOrBuilderAllFields.from_dict(_all_fields)
        ...
        service_options_or_builder = cls(
            features=features,
        ...
        service_options_or_builder.additional_properties = d
        return service_options_or_builder
