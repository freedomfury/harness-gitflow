...
if TYPE_CHECKING:
    ...
    from ..models.sync_executable_response_or_builder_all_fields import SyncExecutableResponseOrBuilderAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="SyncExecutableResponseOrBuilder")


@_attrs_define
class SyncExecutableResponseOrBuilder:
    """
    Attributes:
        ...
        all_fields (SyncExecutableResponseOrBuilderAllFields | Unset):
    ...
    all_fields: SyncExecutableResponseOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = SyncExecutableResponseOrBuilderAllFields.from_dict(_all_fields)
        ...
        sync_executable_response_or_builder = cls(
        ...
        sync_executable_response_or_builder.additional_properties = d
        return sync_executable_response_or_builder
