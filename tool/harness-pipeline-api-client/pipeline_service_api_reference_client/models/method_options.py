...
from ..models.method_options_idempotency_level import (
    MethodOptionsIdempotencyLevel,
    check_method_options_idempotency_level,
)
...
if TYPE_CHECKING:
    ...
    from ..models.method_options_all_fields import MethodOptionsAllFields
    from ..models.method_options_all_fields_raw import MethodOptionsAllFieldsRaw
    from ..models.parser_method_options import ParserMethodOptions
...
T = TypeVar("T", bound="MethodOptions")
...
class MethodOptions:
    ...
    Attributes:
        ...
        idempotency_level (MethodOptionsIdempotencyLevel | Unset):
        initialized (bool | Unset):
        features (FeatureSet | Unset):
        default_instance_for_type (MethodOptions | Unset):
        parser_for_type (ParserMethodOptions | Unset):
        ...
        all_fields (MethodOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (MethodOptionsAllFieldsRaw | Unset):
        memoized_serialized_size (int | Unset):
    """

    unknown_fields: UnknownFieldSet | Unset = UNSET
    idempotency_level: MethodOptionsIdempotencyLevel | Unset = UNSET
    initialized: bool | Unset = UNSET
    features: FeatureSet | Unset = UNSET
    default_instance_for_type: MethodOptions | Unset = UNSET
    parser_for_type: ParserMethodOptions | Unset = UNSET
    ...
    all_fields: MethodOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: MethodOptionsAllFieldsRaw | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_idempotency_level, Unset):
            ...
            idempotency_level = check_method_options_idempotency_level(_idempotency_level)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = MethodOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserMethodOptions.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = MethodOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = MethodOptionsAllFieldsRaw.from_dict(_all_fields_raw)
        ...
        method_options.additional_properties = d
