...
if TYPE_CHECKING:
    ...
    from ..models.pull_request_or_builder_all_fields import PullRequestOrBuilderAllFields
...
T = TypeVar("T", bound="PullRequestOrBuilder")


@_attrs_define
class PullRequestOrBuilder:
    """
    Attributes:
        link (str | Unset):
        sha (str | Unset):
        ...
        title (str | Unset):
        all_fields (PullRequestOrBuilderAllFields | Unset):
    ...
    all_fields: PullRequestOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = PullRequestOrBuilderAllFields.from_dict(_all_fields)
        ...
        pull_request_or_builder.additional_properties = d
        return pull_request_or_builder
