...
if TYPE_CHECKING:
    ...
    from ..models.signature_or_builder_all_fields import SignatureOrBuilderAllFields
    from ..models.timestamp import Timestamp
    from ..models.timestamp_or_builder import TimestampOrBuilder
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="SignatureOrBuilder")


@_attrs_define
class SignatureOrBuilder:
    """
    Attributes:
        ...
        email (str | Unset):
        all_fields (SignatureOrBuilderAllFields | Unset):
    ...
    all_fields: SignatureOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = SignatureOrBuilderAllFields.from_dict(_all_fields)
        ...
        signature_or_builder.additional_properties = d
        return signature_or_builder
