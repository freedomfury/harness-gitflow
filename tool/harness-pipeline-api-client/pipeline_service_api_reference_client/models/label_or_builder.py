...
if TYPE_CHECKING:
    ...
    from ..models.label_or_builder_all_fields import LabelOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="LabelOrBuilder")


@_attrs_define
class LabelOrBuilder:
    """
    Attributes:
        ...
        all_fields (LabelOrBuilderAllFields | Unset):
    ...
    all_fields: LabelOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = LabelOrBuilderAllFields.from_dict(_all_fields)
        ...
        label_or_builder.additional_properties = d
        return label_or_builder
