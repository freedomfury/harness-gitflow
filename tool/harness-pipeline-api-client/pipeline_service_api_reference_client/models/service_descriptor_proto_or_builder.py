...
if TYPE_CHECKING:
    ...
    from ..models.service_descriptor_proto_or_builder_all_fields import ServiceDescriptorProtoOrBuilderAllFields
...
T = TypeVar("T", bound="ServiceDescriptorProtoOrBuilder")
...
class ServiceDescriptorProtoOrBuilder:
    ...
    Attributes:
        ...
        all_fields (ServiceDescriptorProtoOrBuilderAllFields | Unset):
    ...
    all_fields: ServiceDescriptorProtoOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ServiceDescriptorProtoOrBuilderAllFields.from_dict(_all_fields)
        ...
        service_descriptor_proto_or_builder = cls(
            name=name,
            options=options,
        ...
        service_descriptor_proto_or_builder.additional_properties = d
        return service_descriptor_proto_or_builder
