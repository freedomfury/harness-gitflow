...
from ..models.execution_metadata_or_builder_execution_mode import (
    ExecutionMetadataOrBuilderExecutionMode,
    check_execution_metadata_or_builder_execution_mode,
)
from ..models.execution_metadata_or_builder_pipeline_store_type import (
    ExecutionMetadataOrBuilderPipelineStoreType,
    check_execution_metadata_or_builder_pipeline_store_type,
)
...
if TYPE_CHECKING:
    ...
    from ..models.execution_metadata_or_builder_all_fields import ExecutionMetadataOrBuilderAllFields
    from ..models.execution_metadata_or_builder_feature_flag_to_value_map import (
        ExecutionMetadataOrBuilderFeatureFlagToValueMap,
    )
    from ..models.execution_metadata_or_builder_feature_flag_to_value_map_map import (
        ExecutionMetadataOrBuilderFeatureFlagToValueMapMap,
    )
    from ..models.execution_metadata_or_builder_setting_to_value_map import ExecutionMetadataOrBuilderSettingToValueMap
    from ..models.execution_metadata_or_builder_setting_to_value_map_map import (
...
T = TypeVar("T", bound="ExecutionMetadataOrBuilder")


@_attrs_define
class ExecutionMetadataOrBuilder:
    """
    Attributes:
        ...
        pipeline_store_type (ExecutionMetadataOrBuilderPipelineStoreType | Unset):
        ...
        execution_mode (ExecutionMetadataOrBuilderExecutionMode | Unset):
        ...
        setting_to_value_map (ExecutionMetadataOrBuilderSettingToValueMap | Unset):
        setting_to_value_map_map (ExecutionMetadataOrBuilderSettingToValueMapMap | Unset):
        feature_flag_to_value_map_count (int | Unset):
        feature_flag_to_value_map (ExecutionMetadataOrBuilderFeatureFlagToValueMap | Unset):
        feature_flag_to_value_map_map (ExecutionMetadataOrBuilderFeatureFlagToValueMapMap | Unset):
        ...
        all_fields (ExecutionMetadataOrBuilderAllFields | Unset):
    ...
    pipeline_store_type: ExecutionMetadataOrBuilderPipelineStoreType | Unset = UNSET
    ...
    execution_mode: ExecutionMetadataOrBuilderExecutionMode | Unset = UNSET
    ...
    setting_to_value_map: ExecutionMetadataOrBuilderSettingToValueMap | Unset = UNSET
    setting_to_value_map_map: ExecutionMetadataOrBuilderSettingToValueMapMap | Unset = UNSET
    feature_flag_to_value_map_count: int | Unset = UNSET
    feature_flag_to_value_map: ExecutionMetadataOrBuilderFeatureFlagToValueMap | Unset = UNSET
    feature_flag_to_value_map_map: ExecutionMetadataOrBuilderFeatureFlagToValueMapMap | Unset = UNSET
    ...
    all_fields: ExecutionMetadataOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.execution_metadata_or_builder_setting_to_value_map import (
        ...
        if isinstance(_pipeline_store_type, Unset):
            ...
            pipeline_store_type = check_execution_metadata_or_builder_pipeline_store_type(_pipeline_store_type)
        ...
        if isinstance(_execution_mode, Unset):
            ...
            execution_mode = check_execution_metadata_or_builder_execution_mode(_execution_mode)
        ...
        if isinstance(_setting_to_value_map, Unset):
            ...
            setting_to_value_map = ExecutionMetadataOrBuilderSettingToValueMap.from_dict(_setting_to_value_map)
        ...
        if isinstance(_setting_to_value_map_map, Unset):
            ...
            setting_to_value_map_map = ExecutionMetadataOrBuilderSettingToValueMapMap.from_dict(
                _setting_to_value_map_map
            )
        ...
        if isinstance(_feature_flag_to_value_map, Unset):
            ...
            feature_flag_to_value_map = ExecutionMetadataOrBuilderFeatureFlagToValueMap.from_dict(
                _feature_flag_to_value_map
            )
        ...
        if isinstance(_feature_flag_to_value_map_map, Unset):
            ...
            feature_flag_to_value_map_map = ExecutionMetadataOrBuilderFeatureFlagToValueMapMap.from_dict(
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ExecutionMetadataOrBuilderAllFields.from_dict(_all_fields)
        ...
        execution_metadata_or_builder = cls(
        ...
        execution_metadata_or_builder.additional_properties = d
        return execution_metadata_or_builder
