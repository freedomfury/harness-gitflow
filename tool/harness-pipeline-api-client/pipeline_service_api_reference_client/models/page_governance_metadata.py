...
T = TypeVar("T", bound="PageGovernanceMetadata")


@_attrs_define
class PageGovernanceMetadata:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[GovernanceMetadata] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[GovernanceMetadata] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GovernanceMetadata.from_dict(content_item_data)
        ...
        page_governance_metadata.additional_properties = d
        return page_governance_metadata
