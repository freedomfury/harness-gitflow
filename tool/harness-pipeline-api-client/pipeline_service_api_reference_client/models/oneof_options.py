...
if TYPE_CHECKING:
    ...
    from ..models.oneof_options_all_fields import OneofOptionsAllFields
    from ..models.oneof_options_all_fields_raw import OneofOptionsAllFieldsRaw
    from ..models.parser_oneof_options import ParserOneofOptions
...
T = TypeVar("T", bound="OneofOptions")
...
class OneofOptions:
    ...
    Attributes:
        ...
        default_instance_for_type (OneofOptions | Unset):
        parser_for_type (ParserOneofOptions | Unset):
        ...
        all_fields (OneofOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (OneofOptionsAllFieldsRaw | Unset):
    ...
    default_instance_for_type: OneofOptions | Unset = UNSET
    parser_for_type: ParserOneofOptions | Unset = UNSET
    ...
    all_fields: OneofOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: OneofOptionsAllFieldsRaw | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = OneofOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserOneofOptions.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = OneofOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = OneofOptionsAllFieldsRaw.from_dict(_all_fields_raw)
        ...
        oneof_options.additional_properties = d
