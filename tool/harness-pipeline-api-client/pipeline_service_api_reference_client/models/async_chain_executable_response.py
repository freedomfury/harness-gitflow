...
from ..models.async_chain_executable_response_status import (
    AsyncChainExecutableResponseStatus,
    check_async_chain_executable_response_status,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.async_chain_executable_response_all_fields import AsyncChainExecutableResponseAllFields
    from ..models.byte_string import ByteString
    from ..models.descriptor import Descriptor
    from ..models.parser_async_chain_executable_response import ParserAsyncChainExecutableResponse
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="AsyncChainExecutableResponse")


@_attrs_define
class AsyncChainExecutableResponse:
    """
    Attributes:
        ...
        status (AsyncChainExecutableResponseStatus | Unset):
        timeout (int | Unset):
        default_instance_for_type (AsyncChainExecutableResponse | Unset):
        parser_for_type (ParserAsyncChainExecutableResponse | Unset):
        serialized_size (int | Unset):
        status_value (int | Unset):
        callback_ids_list (list[str] | Unset):
        callback_id (str | Unset):
        all_fields (AsyncChainExecutableResponseAllFields | Unset):
    ...
    status: AsyncChainExecutableResponseStatus | Unset = UNSET
    timeout: int | Unset = UNSET
    default_instance_for_type: AsyncChainExecutableResponse | Unset = UNSET
    parser_for_type: ParserAsyncChainExecutableResponse | Unset = UNSET
    serialized_size: int | Unset = UNSET
    status_value: int | Unset = UNSET
    callback_ids_list: list[str] | Unset = UNSET
    callback_id: str | Unset = UNSET
    all_fields: AsyncChainExecutableResponseAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = check_async_chain_executable_response_status(_status)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = AsyncChainExecutableResponse.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserAsyncChainExecutableResponse.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = AsyncChainExecutableResponseAllFields.from_dict(_all_fields)
        ...
        async_chain_executable_response = cls(
        ...
        async_chain_executable_response.additional_properties = d
        return async_chain_executable_response
