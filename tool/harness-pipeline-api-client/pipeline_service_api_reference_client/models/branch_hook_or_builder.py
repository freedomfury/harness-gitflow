...
from ..models.branch_hook_or_builder_action import BranchHookOrBuilderAction, check_branch_hook_or_builder_action
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.branch_hook_or_builder_all_fields import BranchHookOrBuilderAllFields
...
T = TypeVar("T", bound="BranchHookOrBuilder")


@_attrs_define
class BranchHookOrBuilder:
    """
    Attributes:
        sender (User | Unset):
        ...
        ref (Reference | Unset):
        action (BranchHookOrBuilderAction | Unset):
        repo (Repository | Unset):
        all_fields (BranchHookOrBuilderAllFields | Unset):
    ...
    action: BranchHookOrBuilderAction | Unset = UNSET
    repo: Repository | Unset = UNSET
    all_fields: BranchHookOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_action, Unset):
            ...
            action = check_branch_hook_or_builder_action(_action)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = BranchHookOrBuilderAllFields.from_dict(_all_fields)
        ...
        branch_hook_or_builder.additional_properties = d
        return branch_hook_or_builder
