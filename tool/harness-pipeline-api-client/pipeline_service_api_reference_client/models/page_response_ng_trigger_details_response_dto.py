...
T = TypeVar("T", bound="PageResponseNGTriggerDetailsResponseDTO")


@_attrs_define
class PageResponseNGTriggerDetailsResponseDTO:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[NGTriggerDetailsResponseDTO] | Unset):
    ...
    content: list[NGTriggerDetailsResponseDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = NGTriggerDetailsResponseDTO.from_dict(content_item_data)
        ...
        page_response_ng_trigger_details_response_dto = cls(
        ...
        page_response_ng_trigger_details_response_dto.additional_properties = d
        return page_response_ng_trigger_details_response_dto
