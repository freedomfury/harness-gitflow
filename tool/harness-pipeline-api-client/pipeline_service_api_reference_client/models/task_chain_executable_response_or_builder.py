...
from ..models.task_chain_executable_response_or_builder_task_category import (
    TaskChainExecutableResponseOrBuilderTaskCategory,
    check_task_chain_executable_response_or_builder_task_category,
)
...
if TYPE_CHECKING:
    ...
    from ..models.task_chain_executable_response_or_builder_all_fields import (
        TaskChainExecutableResponseOrBuilderAllFields,
    )
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="TaskChainExecutableResponseOrBuilder")


@_attrs_define
class TaskChainExecutableResponseOrBuilder:
    """
    Attributes:
        chain_end (bool | Unset):
        pass_through_data (ByteString | Unset):
        task_category (TaskChainExecutableResponseOrBuilderTaskCategory | Unset):
        ...
        task_id (str | Unset):
        task_name (str | Unset):
        all_fields (TaskChainExecutableResponseOrBuilderAllFields | Unset):
    ...
    task_category: TaskChainExecutableResponseOrBuilderTaskCategory | Unset = UNSET
    ...
    all_fields: TaskChainExecutableResponseOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_task_category, Unset):
            ...
            task_category = check_task_chain_executable_response_or_builder_task_category(_task_category)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = TaskChainExecutableResponseOrBuilderAllFields.from_dict(_all_fields)
        ...
        task_chain_executable_response_or_builder = cls(
            chain_end=chain_end,
        ...
        task_chain_executable_response_or_builder.additional_properties = d
        return task_chain_executable_response_or_builder
