...
from ..models.strategy_info_metadata_case import StrategyInfoMetadataCase, check_strategy_info_metadata_case
...
if TYPE_CHECKING:
    ...
    from ..models.parser_strategy_info import ParserStrategyInfo
    from ..models.strategy_info_all_fields import StrategyInfoAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="StrategyInfo")
...
class StrategyInfo:
    ...
    Attributes:
        ...
        metadata_case (StrategyInfoMetadataCase | Unset):
        initialized (bool | Unset):
        default_instance_for_type (StrategyInfo | Unset):
        parser_for_type (ParserStrategyInfo | Unset):
        serialized_size (int | Unset):
        all_fields (StrategyInfoAllFields | Unset):
    ...
    metadata_case: StrategyInfoMetadataCase | Unset = UNSET
    initialized: bool | Unset = UNSET
    default_instance_for_type: StrategyInfo | Unset = UNSET
    parser_for_type: ParserStrategyInfo | Unset = UNSET
    serialized_size: int | Unset = UNSET
    all_fields: StrategyInfoAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata_case, Unset):
            ...
            metadata_case = check_strategy_info_metadata_case(_metadata_case)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = StrategyInfo.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserStrategyInfo.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = StrategyInfoAllFields.from_dict(_all_fields)
        ...
        strategy_info.additional_properties = d
