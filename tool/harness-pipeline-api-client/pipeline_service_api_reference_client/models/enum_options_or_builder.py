...
if TYPE_CHECKING:
    ...
    from ..models.enum_options_or_builder_all_fields import EnumOptionsOrBuilderAllFields
...
T = TypeVar("T", bound="EnumOptionsOrBuilder")
...
class EnumOptionsOrBuilder:
    ...
    Attributes:
        ...
        all_fields (EnumOptionsOrBuilderAllFields | Unset):
    ...
    all_fields: EnumOptionsOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = EnumOptionsOrBuilderAllFields.from_dict(_all_fields)
        ...
        enum_options_or_builder.additional_properties = d
        return enum_options_or_builder
