...
T = TypeVar("T", bound="ParameterFieldListString")


@_attrs_define
class ParameterFieldListString:
    """
    Attributes:
        expression_value (str | Unset):
        expression (bool | Unset):
        value (list[str] | Unset):
        default_value (list[str] | Unset):
    ...
    default_value: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        default_value = cast(list[str], d.pop("defaultValue", UNSET))
        ...
        parameter_field_list_string = cls(
        ...
        parameter_field_list_string.additional_properties = d
        return parameter_field_list_string
