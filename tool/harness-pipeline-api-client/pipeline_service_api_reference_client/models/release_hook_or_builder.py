...
from ..models.release_hook_or_builder_action import ReleaseHookOrBuilderAction, check_release_hook_or_builder_action
...
if TYPE_CHECKING:
    ...
    from ..models.release_hook_or_builder_all_fields import ReleaseHookOrBuilderAllFields
...
T = TypeVar("T", bound="ReleaseHookOrBuilder")


@_attrs_define
class ReleaseHookOrBuilder:
    """
    Attributes:
        sender (User | Unset):
        ...
        action (ReleaseHookOrBuilderAction | Unset):
        repo (Repository | Unset):
        all_fields (ReleaseHookOrBuilderAllFields | Unset):
    ...
    action: ReleaseHookOrBuilderAction | Unset = UNSET
    repo: Repository | Unset = UNSET
    all_fields: ReleaseHookOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_action, Unset):
            ...
            action = check_release_hook_or_builder_action(_action)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ReleaseHookOrBuilderAllFields.from_dict(_all_fields)
        ...
        release_hook_or_builder.additional_properties = d
        return release_hook_or_builder
