...
if TYPE_CHECKING:
    ...
    from ..models.parser_service_options import ParserServiceOptions
    from ..models.service_options_all_fields import ServiceOptionsAllFields
    from ..models.service_options_all_fields_raw import ServiceOptionsAllFieldsRaw
...
class ServiceOptions:
    ...
    Attributes:
        ...
        default_instance_for_type (ServiceOptions | Unset):
        parser_for_type (ParserServiceOptions | Unset):
        ...
        all_fields (ServiceOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (ServiceOptionsAllFieldsRaw | Unset):
    ...
    default_instance_for_type: ServiceOptions | Unset = UNSET
    parser_for_type: ParserServiceOptions | Unset = UNSET
    ...
    all_fields: ServiceOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: ServiceOptionsAllFieldsRaw | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = ServiceOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserServiceOptions.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ServiceOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = ServiceOptionsAllFieldsRaw.from_dict(_all_fields_raw)
        ...
        service_options.additional_properties = d
