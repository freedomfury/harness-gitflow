...
if TYPE_CHECKING:
    ...
    from ..models.reference_or_builder_all_fields import ReferenceOrBuilderAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="ReferenceOrBuilder")


@_attrs_define
class ReferenceOrBuilder:
    """
    Attributes:
        sha (str | Unset):
        ...
        all_fields (ReferenceOrBuilderAllFields | Unset):
    ...
    all_fields: ReferenceOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ReferenceOrBuilderAllFields.from_dict(_all_fields)
        ...
        reference_or_builder.additional_properties = d
        return reference_or_builder
