...
if TYPE_CHECKING:
    from ..models.child_execution_detail import ChildExecutionDetail
    from ..models.execution_graph import ExecutionGraph
    from ..models.pipeline_execution_summary import PipelineExecutionSummary


T = TypeVar("T", bound="PipelineExecutionDetail")


@_attrs_define
class PipelineExecutionDetail:
    ...
    Attributes:
        ...
        child_graph (ChildExecutionDetail | Unset): This contains the Pipeline Execution details of Child Pipeline
    """

    pipeline_execution_summary: PipelineExecutionSummary | Unset = UNSET
    execution_graph: ExecutionGraph | Unset = UNSET
    child_graph: ChildExecutionDetail | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        child_graph: dict[str, Any] | Unset = UNSET
        if not isinstance(self.child_graph, Unset):
            child_graph = self.child_graph.to_dict()
        ...
        if child_graph is not UNSET:
            field_dict["childGraph"] = child_graph
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _child_graph = d.pop("childGraph", UNSET)
        child_graph: ChildExecutionDetail | Unset
        if isinstance(_child_graph, Unset):
            child_graph = UNSET
        else:
            child_graph = ChildExecutionDetail.from_dict(_child_graph)

        pipeline_execution_detail = cls(
            pipeline_execution_summary=pipeline_execution_summary,
            execution_graph=execution_graph,
            child_graph=child_graph,
        )

        pipeline_execution_detail.additional_properties = d
        return pipeline_execution_detail
