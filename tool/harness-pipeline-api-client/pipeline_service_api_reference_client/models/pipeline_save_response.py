...
T = TypeVar("T", bound="PipelineSaveResponse")


@_attrs_define
class PipelineSaveResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pipeline_save_response = cls(
            identifier=identifier,
            governance_metadata=governance_metadata,
            public_access_response=public_access_response,
        )

        pipeline_save_response.additional_properties = d
        return pipeline_save_response
