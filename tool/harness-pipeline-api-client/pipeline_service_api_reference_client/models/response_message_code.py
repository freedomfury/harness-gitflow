...
RESPONSE_MESSAGE_CODE_VALUES: set[ResponseMessageCode] = {
    "ABORT_ALL_ALREADY",
    "ABORT_ALL_ALREADY_NG",
    "ACCESS_DENIED",
    "ACCOUNT_DISABLED",
...
def check_response_message_code(value: str) -> ResponseMessageCode:
    if value in RESPONSE_MESSAGE_CODE_VALUES:
        return cast(ResponseMessageCode, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {RESPONSE_MESSAGE_CODE_VALUES!r}")
