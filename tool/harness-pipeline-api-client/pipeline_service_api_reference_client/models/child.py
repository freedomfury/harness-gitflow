...
if TYPE_CHECKING:
    ...
    from ..models.child_all_fields import ChildAllFields
    from ..models.descriptor import Descriptor
    from ..models.parser_child import ParserChild
...
class Child:
    ...
    Attributes:
        ...
        default_instance_for_type (Child | Unset):
        parser_for_type (ParserChild | Unset):
        serialized_size (int | Unset):
        child_node_id (str | Unset):
        strategy_metadata (StrategyMetadata | Unset):
        all_fields (ChildAllFields | Unset):
    ...
    default_instance_for_type: Child | Unset = UNSET
    parser_for_type: ParserChild | Unset = UNSET
    serialized_size: int | Unset = UNSET
    child_node_id: str | Unset = UNSET
    strategy_metadata: StrategyMetadata | Unset = UNSET
    all_fields: ChildAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = Child.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserChild.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = ChildAllFields.from_dict(_all_fields)
