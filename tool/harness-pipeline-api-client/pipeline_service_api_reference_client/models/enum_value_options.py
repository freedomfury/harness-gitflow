...
if TYPE_CHECKING:
    ...
    from ..models.enum_value_options_all_fields import EnumValueOptionsAllFields
    from ..models.enum_value_options_all_fields_raw import EnumValueOptionsAllFieldsRaw
    ...
    from ..models.parser_enum_value_options import ParserEnumValueOptions
...
T = TypeVar("T", bound="EnumValueOptions")
...
class EnumValueOptions:
    ...
    Attributes:
        ...
        default_instance_for_type (EnumValueOptions | Unset):
        parser_for_type (ParserEnumValueOptions | Unset):
        ...
        all_fields (EnumValueOptionsAllFields | Unset):
        initialization_error_string (str | Unset):
        descriptor_for_type (Descriptor | Unset):
        all_fields_raw (EnumValueOptionsAllFieldsRaw | Unset):
    ...
    default_instance_for_type: EnumValueOptions | Unset = UNSET
    parser_for_type: ParserEnumValueOptions | Unset = UNSET
    ...
    all_fields: EnumValueOptionsAllFields | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    descriptor_for_type: Descriptor | Unset = UNSET
    all_fields_raw: EnumValueOptionsAllFieldsRaw | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = EnumValueOptions.from_dict(_default_instance_for_type)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserEnumValueOptions.from_dict(_parser_for_type)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = EnumValueOptionsAllFields.from_dict(_all_fields)
        ...
        if isinstance(_all_fields_raw, Unset):
            ...
            all_fields_raw = EnumValueOptionsAllFieldsRaw.from_dict(_all_fields_raw)

        memoized_serialized_size = d.pop("memoizedSerializedSize", UNSET)

        enum_value_options = cls(
        ...
        enum_value_options.additional_properties = d
