...
if TYPE_CHECKING:
    from ..models.ng_trigger_event_history_base_dto import NGTriggerEventHistoryBaseDTO
    from ..models.pageable import Pageable
    from ..models.sort import Sort


T = TypeVar("T", bound="PageNGTriggerEventHistoryBaseDTO")


@_attrs_define
class PageNGTriggerEventHistoryBaseDTO:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[NGTriggerEventHistoryBaseDTO] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[NGTriggerEventHistoryBaseDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = NGTriggerEventHistoryBaseDTO.from_dict(content_item_data)
        ...
        page_ng_trigger_event_history_base_dto = cls(
        ...
        page_ng_trigger_event_history_base_dto.additional_properties = d
        return page_ng_trigger_event_history_base_dto
