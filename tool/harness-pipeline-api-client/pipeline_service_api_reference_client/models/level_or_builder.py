...
if TYPE_CHECKING:
    ...
    from ..models.level_or_builder_all_fields import LevelOrBuilderAllFields
...
T = TypeVar("T", bound="LevelOrBuilder")


@_attrs_define
class LevelOrBuilder:
    """
    Attributes:
        ...
        all_fields (LevelOrBuilderAllFields | Unset):
    ...
    all_fields: LevelOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = LevelOrBuilderAllFields.from_dict(_all_fields)
        ...
        level_or_builder.additional_properties = d
        return level_or_builder
