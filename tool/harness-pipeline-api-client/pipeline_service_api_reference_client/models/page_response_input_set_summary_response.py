...
T = TypeVar("T", bound="PageResponseInputSetSummaryResponse")


@_attrs_define
class PageResponseInputSetSummaryResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[InputSetSummaryResponse] | Unset):
    ...
    content: list[InputSetSummaryResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = InputSetSummaryResponse.from_dict(content_item_data)
        ...
        page_response_input_set_summary_response = cls(
        ...
        page_response_input_set_summary_response.additional_properties = d
        return page_response_input_set_summary_response
