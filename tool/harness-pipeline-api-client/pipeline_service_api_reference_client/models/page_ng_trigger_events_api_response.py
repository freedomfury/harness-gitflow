...
if TYPE_CHECKING:
    from ..models.ng_trigger_events_api_response import NGTriggerEventsApiResponse
    from ..models.pageable import Pageable
    from ..models.sort import Sort


T = TypeVar("T", bound="PageNGTriggerEventsApiResponse")


@_attrs_define
class PageNGTriggerEventsApiResponse:
    """
    Attributes:
        ...
        first (bool | Unset):
        size (int | Unset):
        content (list[NGTriggerEventsApiResponse] | Unset):
        number (int | Unset):
        sort (Sort | Unset):
    ...
    content: list[NGTriggerEventsApiResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = NGTriggerEventsApiResponse.from_dict(content_item_data)
        ...
        page_ng_trigger_events_api_response = cls(
        ...
        page_ng_trigger_events_api_response.additional_properties = d
        return page_ng_trigger_events_api_response
