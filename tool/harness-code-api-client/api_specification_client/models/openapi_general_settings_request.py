...
T = TypeVar("T", bound="OpenapiGeneralSettingsRequest")


@_attrs_define
class OpenapiGeneralSettingsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openapi_general_settings_request = cls(
            auto_merge_enabled=auto_merge_enabled,
            file_size_limit=file_size_limit,
            git_lfs_enabled=git_lfs_enabled,
        )

        openapi_general_settings_request.additional_properties = d
        return openapi_general_settings_request
