...
T = TypeVar("T", bound="TypesPullReqStats")


@_attrs_define
class TypesPullReqStats:
    """
    Attributes:
    ...
    unresolved_count: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if unresolved_count is not UNSET:
            field_dict["unresolved_count"] = unresolved_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unresolved_count = d.pop("unresolved_count", UNSET)

        types_pull_req_stats = cls(
            additions=additions,
            commits=commits,
        ...
        types_pull_req_stats.additional_properties = d
        return types_pull_req_stats
