...
T = TypeVar("T", bound="SettingsSecuritySettings")
...
class SettingsSecuritySettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        settings_security_settings = cls(
        ...
        settings_security_settings.additional_properties = d
        return settings_security_settings
