...
T = TypeVar("T", bound="OpenapiUpdateRepoWebhookRequest")


@_attrs_define
class OpenapiUpdateRepoWebhookRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openapi_update_repo_webhook_request = cls(
        ...
        openapi_update_repo_webhook_request.additional_properties = d
        return openapi_update_repo_webhook_request
