...
T = TypeVar("T", bound="TypesSquashResponse")


@_attrs_define
class TypesSquashResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        types_squash_response.additional_properties = d
        return types_squash_response
