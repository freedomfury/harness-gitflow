...
T = TypeVar("T", bound="UpdateSpaceLabelBody")


@_attrs_define
class UpdateSpaceLabelBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_space_label_body.additional_properties = d
        return update_space_label_body
