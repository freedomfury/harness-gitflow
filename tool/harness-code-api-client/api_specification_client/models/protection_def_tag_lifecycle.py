...
T = TypeVar("T", bound="ProtectionDefTagLifecycle")


@_attrs_define
class ProtectionDefTagLifecycle:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        protection_def_tag_lifecycle = cls(
            create_forbidden=create_forbidden,
            delete_forbidden=delete_forbidden,
            update_force_forbidden=update_force_forbidden,
        )

        protection_def_tag_lifecycle.additional_properties = d
        return protection_def_tag_lifecycle
