...
T = TypeVar("T", bound="OpenapiPullReqAssignLabelInput")


@_attrs_define
class OpenapiPullReqAssignLabelInput:
    """
    Attributes:
        label_id (int | Unset):
        value (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openapi_pull_req_assign_label_input = cls(
            label_id=label_id,
            value=value,
            value_id=value_id,
        )

        openapi_pull_req_assign_label_input.additional_properties = d
        return openapi_pull_req_assign_label_input
