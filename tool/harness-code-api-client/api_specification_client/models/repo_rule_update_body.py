...
T = TypeVar("T", bound="RepoRuleUpdateBody")


@_attrs_define
class RepoRuleUpdateBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repo_rule_update_body.additional_properties = d
        return repo_rule_update_body
