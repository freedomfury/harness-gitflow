...
T = TypeVar("T", bound="DefineSpaceLabelBody")


@_attrs_define
class DefineSpaceLabelBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        define_space_label_body.additional_properties = d
        return define_space_label_body
