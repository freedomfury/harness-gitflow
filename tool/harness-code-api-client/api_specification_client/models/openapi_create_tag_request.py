...
T = TypeVar("T", bound="OpenapiCreateTagRequest")


@_attrs_define
class OpenapiCreateTagRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openapi_create_tag_request = cls(
        ...
        openapi_create_tag_request.additional_properties = d
        return openapi_create_tag_request
