...
T = TypeVar("T", bound="SaveRepoLabelBody")


@_attrs_define
class SaveRepoLabelBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        save_repo_label_body = cls(
            label=label,
            values=values,
        )

        save_repo_label_body.additional_properties = d
        return save_repo_label_body
