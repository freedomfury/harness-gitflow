...
T = TypeVar("T", bound="TypesPullReqActivityMentions")


@_attrs_define
class TypesPullReqActivityMentions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        types_pull_req_activity_mentions = cls()
        ...
        types_pull_req_activity_mentions.additional_properties = additional_properties
        return types_pull_req_activity_mentions
