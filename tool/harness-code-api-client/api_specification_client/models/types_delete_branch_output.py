...
T = TypeVar("T", bound="TypesDeleteBranchOutput")


@_attrs_define
class TypesDeleteBranchOutput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        types_delete_branch_output = cls(
            dry_run_rules=dry_run_rules,
            rule_violations=rule_violations,
        )

        types_delete_branch_output.additional_properties = d
        return types_delete_branch_output
