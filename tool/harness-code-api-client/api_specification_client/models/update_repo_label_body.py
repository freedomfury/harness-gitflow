...
T = TypeVar("T", bound="UpdateRepoLabelBody")


@_attrs_define
class UpdateRepoLabelBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_repo_label_body.additional_properties = d
        return update_repo_label_body
