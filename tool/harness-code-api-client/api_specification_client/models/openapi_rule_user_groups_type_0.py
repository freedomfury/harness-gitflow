...
T = TypeVar("T", bound="OpenapiRuleUserGroupsType0")


@_attrs_define
class OpenapiRuleUserGroupsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        openapi_rule_user_groups_type_0 = cls()
        ...
        openapi_rule_user_groups_type_0.additional_properties = additional_properties
        return openapi_rule_user_groups_type_0
