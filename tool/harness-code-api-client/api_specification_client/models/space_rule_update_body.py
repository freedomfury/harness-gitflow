...
T = TypeVar("T", bound="SpaceRuleUpdateBody")


@_attrs_define
class SpaceRuleUpdateBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        space_rule_update_body.additional_properties = d
        return space_rule_update_body
