...
T = TypeVar("T", bound="TypesSaveLabelInput")


@_attrs_define
class TypesSaveLabelInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        types_save_label_input.additional_properties = d
        return types_save_label_input
