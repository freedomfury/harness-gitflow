...
T = TypeVar("T", bound="OpenapiCreateRepoWebhookRequest")


@_attrs_define
class OpenapiCreateRepoWebhookRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        openapi_create_repo_webhook_request = cls(
        ...
        openapi_create_repo_webhook_request.additional_properties = d
        return openapi_create_repo_webhook_request
