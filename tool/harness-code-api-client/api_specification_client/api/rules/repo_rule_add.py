...
from ...models.repo_rule_add_body import RepoRuleAddBody
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: RepoRuleAddBody | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = OpenapiRule.from_dict(response.json())
