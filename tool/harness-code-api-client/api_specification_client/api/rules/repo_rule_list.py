...
from ...models.repo_rule_list_order import RepoRuleListOrder
from ...models.repo_rule_list_sort import RepoRuleListSort
from ...models.repo_rule_list_type_item import RepoRuleListTypeItem
...
def _get_kwargs(
    ...
    *,
    ...
    order: RepoRuleListOrder | Unset = RepoRuleListOrder.ASC,
    sort: RepoRuleListSort | Unset = RepoRuleListSort.CREATED_AT,
    type_: list[RepoRuleListTypeItem] | Unset = UNSET,
    page: int | Unset = 1,
    limit: int | Unset = 30,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/rules".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        query (str | Unset):
        order (RepoRuleListOrder | Unset):  Default: RepoRuleListOrder.ASC.
        sort (RepoRuleListSort | Unset):  Default: RepoRuleListSort.CREATED_AT.
        type_ (list[RepoRuleListTypeItem] | Unset):
