...
from ...models.revert_pull_req_op_body import RevertPullReqOpBody
from ...models.types_revert_response import TypesRevertResponse
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: RevertPullReqOpBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/revert".format(
...
) -> TypesRevertResponse | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesRevertResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesRevertResponse | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (RevertPullReqOpBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesRevertResponse | UsererrorError
    """
