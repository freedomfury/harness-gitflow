...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/metadata".format(
...
) -> TypesPullReqStats | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesPullReqStats.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesPullReqStats | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesPullReqStats | UsererrorError
    """
