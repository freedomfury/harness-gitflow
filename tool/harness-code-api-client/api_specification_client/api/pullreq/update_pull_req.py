...
from ...models.openapi_update_pull_req_request import OpenapiUpdatePullReqRequest
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiUpdatePullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiUpdatePullReqRequest | Unset):
