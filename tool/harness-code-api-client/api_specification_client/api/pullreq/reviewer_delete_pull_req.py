...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/reviewers/{pullreq_reviewer_id}".format(
            repo_identifier=quote(str(repo_identifier), safe=""),
            pullreq_number=quote(str(pullreq_number), safe=""),
            pullreq_reviewer_id=quote(str(pullreq_reviewer_id), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    kwargs = _get_kwargs(
        ...
        pullreq_reviewer_id=pullreq_reviewer_id,
