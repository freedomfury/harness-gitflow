...
from ...models.pullreq_combined_list_response import PullreqCombinedListResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/reviewers/combined".format(
...
) -> PullreqCombinedListResponse | UsererrorError | None:
    if response.status_code == 200:
        response_200 = PullreqCombinedListResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PullreqCombinedListResponse | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        PullreqCombinedListResponse | UsererrorError
    """
