...
from ...models.types_pull_req_checks import TypesPullReqChecks
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/checks".format(
...
) -> TypesPullReqChecks | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesPullReqChecks.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesPullReqChecks | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesPullReqChecks | UsererrorError
    """
