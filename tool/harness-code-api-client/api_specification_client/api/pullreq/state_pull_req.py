...
from ...models.openapi_state_pull_req_request import OpenapiStatePullReqRequest
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiStatePullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/state".format(
...
) -> TypesPullReq | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesPullReq.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesPullReq | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiStatePullReqRequest | Unset):
