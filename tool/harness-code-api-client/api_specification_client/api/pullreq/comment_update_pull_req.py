...
from ...models.openapi_comment_update_pull_req_request import OpenapiCommentUpdatePullReqRequest
...
def _get_kwargs(
    ...
    *,
    body: OpenapiCommentUpdatePullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/comments/{pullreq_comment_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiCommentUpdatePullReqRequest | Unset):
