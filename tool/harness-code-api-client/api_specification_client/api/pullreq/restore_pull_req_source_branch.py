...
from ...models.restore_pull_req_source_branch_body import RestorePullReqSourceBranchBody
from ...models.types_create_branch_output import TypesCreateBranchOutput
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: RestorePullReqSourceBranchBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/branch".format(
...
) -> TypesCreateBranchOutput | TypesRulesViolations | UsererrorError | None:
    if response.status_code == 201:
        response_201 = TypesCreateBranchOutput.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesCreateBranchOutput | TypesRulesViolations | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (RestorePullReqSourceBranchBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesCreateBranchOutput | TypesRulesViolations | UsererrorError
    """
