...
from ...models.types_code_owner_evaluation import TypesCodeOwnerEvaluation
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/codeowners".format(
...
) -> TypesCodeOwnerEvaluation | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesCodeOwnerEvaluation.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesCodeOwnerEvaluation | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesCodeOwnerEvaluation | UsererrorError
    """
