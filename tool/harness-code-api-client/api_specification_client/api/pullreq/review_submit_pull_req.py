...
from ...models.openapi_review_submit_pull_req_request import OpenapiReviewSubmitPullReqRequest
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiReviewSubmitPullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/reviews".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiReviewSubmitPullReqRequest | Unset):
