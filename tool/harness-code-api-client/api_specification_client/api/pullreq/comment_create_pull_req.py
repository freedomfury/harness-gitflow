...
from ...models.openapi_comment_create_pull_req_request import OpenapiCommentCreatePullReqRequest
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiCommentCreatePullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/comments".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TypesPullReqActivity.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiCommentCreatePullReqRequest | Unset):
