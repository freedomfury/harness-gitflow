...
from ...models.openapi_create_pull_req_request import OpenapiCreatePullReqRequest
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: OpenapiCreatePullReqRequest | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TypesPullReq.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiCreatePullReqRequest | Unset):
