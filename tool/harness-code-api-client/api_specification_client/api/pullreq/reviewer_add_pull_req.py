...
from ...models.openapi_reviewer_add_pull_req_request import OpenapiReviewerAddPullReqRequest
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiReviewerAddPullReqRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/repos/{repo_identifier}/pullreq/{pullreq_number}/reviewers".format(
...
) -> TypesPullReqReviewer | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesPullReqReviewer.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesPullReqReviewer | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiReviewerAddPullReqRequest | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesPullReqReviewer | UsererrorError
    """
