...
from ...models.define_space_label_value_body import DefineSpaceLabelValueBody
...
def _get_kwargs(
    key: str,
    *,
    body: DefineSpaceLabelValueBody | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TypesLabelValue.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (DefineSpaceLabelValueBody | Unset):
