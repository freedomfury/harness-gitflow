...
from ...models.define_space_label_body import DefineSpaceLabelBody
...
def _get_kwargs(
    *,
    body: DefineSpaceLabelBody | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = TypesLabel.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (DefineSpaceLabelBody | Unset):
