...
from ...models.update_space_label_body import UpdateSpaceLabelBody
...
def _get_kwargs(
    key: str,
    *,
    body: UpdateSpaceLabelBody | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateSpaceLabelBody | Unset):
