...
from ...models.save_repo_label_body import SaveRepoLabelBody
from ...models.types_label_with_values import TypesLabelWithValues
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: SaveRepoLabelBody | Unset = UNSET,
...
) -> TypesLabelWithValues | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesLabelWithValues.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesLabelWithValues | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesLabelWithValues | UsererrorError
    """
