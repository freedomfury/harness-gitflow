...
from ...models.update_repo_label_body import UpdateRepoLabelBody
...
def _get_kwargs(
    ...
    key: str,
    *,
    body: UpdateRepoLabelBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/repos/{repo_identifier}/labels/{key}".format(
...
) -> TypesLabel | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesLabel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesLabel | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateRepoLabelBody | Unset):
