...
from ...models.openapi_pull_req_assign_label_input import OpenapiPullReqAssignLabelInput
from ...models.types_pull_req_label import TypesPullReqLabel
...
def _get_kwargs(
    ...
    pullreq_number: int,
    *,
    body: OpenapiPullReqAssignLabelInput | Unset = UNSET,
...
) -> TypesPullReqLabel | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesPullReqLabel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesPullReqLabel | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiPullReqAssignLabelInput | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesPullReqLabel | UsererrorError
    """
