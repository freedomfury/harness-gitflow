...
from ...models.update_repo_label_value_body import UpdateRepoLabelValueBody
...
def _get_kwargs(
    ...
    value: str,
    *,
    body: UpdateRepoLabelValueBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/repos/{repo_identifier}/labels/{key}/values/{value}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateRepoLabelValueBody | Unset):
