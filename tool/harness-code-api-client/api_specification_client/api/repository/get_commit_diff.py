...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/commits/{commit_sha}/diff".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> UsererrorError | str | None:
