...
from ...models.rebase_branch_body import RebaseBranchBody
from ...models.types_merge_violations import TypesMergeViolations
from ...models.types_rebase_response import TypesRebaseResponse
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: RebaseBranchBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/rebase".format(
...
) -> TypesMergeViolations | TypesRebaseResponse | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesRebaseResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesMergeViolations | TypesRebaseResponse | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        TypesMergeViolations | TypesRebaseResponse | UsererrorError
    """
