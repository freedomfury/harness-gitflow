...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/commits/{commit_sha}".format(
...
) -> TypesCommit | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesCommit.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesCommit | UsererrorError]:
    return Response(
