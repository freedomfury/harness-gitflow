...
from ...models.openapi_update_repo_request import OpenapiUpdateRepoRequest
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: OpenapiUpdateRepoRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/repos/{repo_identifier}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (OpenapiUpdateRepoRequest | Unset):
