...
from ...models.repo_merge_check import RepoMergeCheck
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/merge-check/{range_}".format(
...
) -> RepoMergeCheck | UsererrorError | None:
    if response.status_code == 200:
        response_200 = RepoMergeCheck.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[RepoMergeCheck | UsererrorError]:
    return Response(
