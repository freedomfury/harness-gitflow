...
from ...models.repo_soft_delete_response import RepoSoftDeleteResponse
...
) -> RepoSoftDeleteResponse | UsererrorError | None:
    if response.status_code == 200:
        response_200 = RepoSoftDeleteResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[RepoSoftDeleteResponse | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        RepoSoftDeleteResponse | UsererrorError
    """
