...
from ...models.openapi_restore_request import OpenapiRestoreRequest
...
def _get_kwargs(
    repo_identifier: str,
    *,
    body: OpenapiRestoreRequest | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/restore".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        deleted_at (int):
        body (OpenapiRestoreRequest | Unset):
