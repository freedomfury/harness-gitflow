...
from ...models.openapi_create_repository_request import OpenapiCreateRepositoryRequest
...
def _get_kwargs(
    *,
    body: OpenapiCreateRepositoryRequest | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RepoRepositoryOutput.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (OpenapiCreateRepositoryRequest | Unset):
