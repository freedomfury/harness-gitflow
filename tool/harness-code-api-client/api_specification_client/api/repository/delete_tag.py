...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/repos/{repo_identifier}/tags/{tag_name}".format(
...
) -> Any | TypesRulesViolations | UsererrorError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | TypesRulesViolations | UsererrorError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | TypesRulesViolations | UsererrorError
    """
