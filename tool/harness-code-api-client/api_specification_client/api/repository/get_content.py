...
from ...models.openapi_get_content_output import OpenapiGetContentOutput
...
def _get_kwargs(
    ...
    *,
    ...
    flatten_directories: bool | Unset = False,
) -> dict[str, Any]:
    ...
    params["flatten_directories"] = flatten_directories

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/content/{path}".format(
...
) -> OpenapiGetContentOutput | UsererrorError | None:
    if response.status_code == 200:
        response_200 = OpenapiGetContentOutput.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[OpenapiGetContentOutput | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        flatten_directories (bool | Unset):  Default: False.
...
def sync(
    ...
    *,
    ...
    Returns:
        OpenapiGetContentOutput | UsererrorError
    """
