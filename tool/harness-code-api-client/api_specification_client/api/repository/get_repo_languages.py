...
from ...models.types_repo_lang_stat import TypesRepoLangStat
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/languages".format(
...
) -> UsererrorError | list[TypesRepoLangStat] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TypesRepoLangStat.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[UsererrorError | list[TypesRepoLangStat]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        UsererrorError | list[TypesRepoLangStat]
    """
