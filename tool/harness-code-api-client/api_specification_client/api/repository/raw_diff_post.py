...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/repos/{repo_identifier}/diff/{range_}".format(
    ...
    if isinstance(body, list):
        _kwargs["json"] = []
        for componentsschemas_openapi_post_raw_diff_request_type_0_item_data in body:
            componentsschemas_openapi_post_raw_diff_request_type_0_item = (
                componentsschemas_openapi_post_raw_diff_request_type_0_item_data.to_dict()
            )
            _kwargs["json"].append(componentsschemas_openapi_post_raw_diff_request_type_0_item)
