...
from ...models.list_branches_order import ListBranchesOrder
from ...models.list_branches_sort import ListBranchesSort
...
def _get_kwargs(
    ...
    *,
    ...
    order: ListBranchesOrder | Unset = ListBranchesOrder.ASC,
    sort: ListBranchesSort | Unset = ListBranchesSort.NAME,
    page: int | Unset = 1,
    limit: int | Unset = 30,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/repos/{repo_identifier}/branches".format(
...
) -> UsererrorError | list[TypesBranchExtended] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TypesBranchExtended.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[UsererrorError | list[TypesBranchExtended]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        query (str | Unset):
        order (ListBranchesOrder | Unset):  Default: ListBranchesOrder.ASC.
        sort (ListBranchesSort | Unset):  Default: ListBranchesSort.NAME.
...
def sync(
    ...
    *,
    ...
    Returns:
        UsererrorError | list[TypesBranchExtended]
    """
