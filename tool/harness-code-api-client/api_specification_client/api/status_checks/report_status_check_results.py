...
from ...models.report_status_check_results_body import ReportStatusCheckResultsBody
...
def _get_kwargs(
    ...
    commit_sha: str,
    *,
    body: ReportStatusCheckResultsBody | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/repos/{repo_identifier}/checks/commits/{commit_sha}".format(
...
) -> TypesCheck | UsererrorError | None:
    if response.status_code == 200:
        response_200 = TypesCheck.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[TypesCheck | UsererrorError]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ReportStatusCheckResultsBody | Unset):
