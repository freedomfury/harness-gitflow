...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_list_delegate_list_response_meta_data import (
        RestResponseListDelegateListResponseMetaData,
    )


T = TypeVar("T", bound="RestResponseListDelegateListResponse")


@_attrs_define
class RestResponseListDelegateListResponse:
    """
    Attributes:
        meta_data (RestResponseListDelegateListResponseMetaData | Unset):
        resource (list[DelegateListResponse] | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseListDelegateListResponseMetaData | Unset = UNSET
    resource: list[DelegateListResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseListDelegateListResponseMetaData.from_dict(_meta_data)
        ...
        if _resource is not UNSET:
            ...
            for resource_item_data in _resource:
                resource_item = DelegateListResponse.from_dict(resource_item_data)
        ...
        rest_response_list_delegate_list_response = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_list_delegate_list_response.additional_properties = d
        return rest_response_list_delegate_list_response
