...
T = TypeVar("T", bound="JenkinsUserNamePasswordDTO")


@_attrs_define
class JenkinsUserNamePasswordDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jenkins_user_name_password_dto = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        jenkins_user_name_password_dto.additional_properties = d
        return jenkins_user_name_password_dto
