...
T = TypeVar("T", bound="GitlabUsernamePassword")


@_attrs_define
class GitlabUsernamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gitlab_username_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        gitlab_username_password.additional_properties = d
        return gitlab_username_password
