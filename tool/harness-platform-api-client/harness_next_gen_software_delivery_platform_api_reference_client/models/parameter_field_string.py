...
T = TypeVar("T", bound="ParameterFieldString")


@_attrs_define
class ParameterFieldString:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameter_field_string.additional_properties = d
        return parameter_field_string
