...
from ..models.gitlab_connector_type import GitlabConnectorType, check_gitlab_connector_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.gitlab_api_access import GitlabApiAccess
    from ..models.gitlab_authentication import GitlabAuthentication


T = TypeVar("T", bound="GitlabConnector")
...
class GitlabConnector:
    ...
    Attributes:
        connector_type (str):
        url (str):
        authentication (GitlabAuthentication): This contains details of the information needed for Gitlab access
        type_ (GitlabConnectorType):
        validation_repo (str | Unset):
        api_access (GitlabApiAccess | Unset): This contains details of the information needed for Gitlab API access
    ...
    api_access: GitlabApiAccess | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication = GitlabAuthentication.from_dict(d.pop("authentication"))

        type_ = check_gitlab_connector_type(d.pop("type"))

        validation_repo = d.pop("validationRepo", UNSET)

        _api_access = d.pop("apiAccess", UNSET)
        api_access: GitlabApiAccess | Unset
        if isinstance(_api_access, Unset):
            api_access = UNSET
        else:
            api_access = GitlabApiAccess.from_dict(_api_access)
        ...
        gitlab_connector.additional_properties = d
        return gitlab_connector
