...
if TYPE_CHECKING:
    ...
    from ..models.environment_response_details import EnvironmentResponseDetails
...
class EnvironmentResponse:
    """
    Attributes:
        environment (EnvironmentResponseDetails | Unset): This is the Environment entity defined in Harness
    ...
    environment: EnvironmentResponseDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment: EnvironmentResponseDetails | Unset
        if isinstance(_environment, Unset):
            environment = UNSET
        else:
            environment = EnvironmentResponseDetails.from_dict(_environment)
