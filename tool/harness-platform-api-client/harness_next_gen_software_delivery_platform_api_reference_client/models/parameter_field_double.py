...
T = TypeVar("T", bound="ParameterFieldDouble")


@_attrs_define
class ParameterFieldDouble:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameter_field_double.additional_properties = d
        return parameter_field_double
