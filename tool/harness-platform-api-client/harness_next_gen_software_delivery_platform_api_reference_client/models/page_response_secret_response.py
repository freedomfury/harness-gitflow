...
T = TypeVar("T", bound="PageResponseSecretResponse")


@_attrs_define
class PageResponseSecretResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[SecretResponse] | Unset):
    ...
    content: list[SecretResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = SecretResponse.from_dict(content_item_data)
        ...
        page_response_secret_response = cls(
        ...
        page_response_secret_response.additional_properties = d
        return page_response_secret_response
