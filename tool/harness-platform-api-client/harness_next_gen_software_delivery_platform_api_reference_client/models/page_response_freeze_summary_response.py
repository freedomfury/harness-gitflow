...
T = TypeVar("T", bound="PageResponseFreezeSummaryResponse")


@_attrs_define
class PageResponseFreezeSummaryResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[FreezeSummaryResponse] | Unset):
    ...
    content: list[FreezeSummaryResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = FreezeSummaryResponse.from_dict(content_item_data)
        ...
        page_response_freeze_summary_response = cls(
        ...
        page_response_freeze_summary_response.additional_properties = d
        return page_response_freeze_summary_response
