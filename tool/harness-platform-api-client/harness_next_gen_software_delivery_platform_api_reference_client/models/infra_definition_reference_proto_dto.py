...
if TYPE_CHECKING:
    ...
    from ..models.infra_definition_reference_proto_dto_all_fields import InfraDefinitionReferenceProtoDTOAllFields
    from ..models.infra_definition_reference_proto_dto_metadata import InfraDefinitionReferenceProtoDTOMetadata
    from ..models.infra_definition_reference_proto_dto_metadata_map import InfraDefinitionReferenceProtoDTOMetadataMap
    from ..models.parser_infra_definition_reference_proto_dto import ParserInfraDefinitionReferenceProtoDTO
    from ..models.string_value import StringValue
    from ..models.string_value_or_builder import StringValueOrBuilder
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="InfraDefinitionReferenceProtoDTO")


@_attrs_define
class InfraDefinitionReferenceProtoDTO:
    """
    Attributes:
        unknown_fields (UnknownFieldSet | Unset):
        env_identifier (StringValue | Unset):
        ...
        env_name (StringValue | Unset):
        metadata_count (int | Unset):
        metadata (InfraDefinitionReferenceProtoDTOMetadata | Unset):
        ...
        env_identifier_or_builder (StringValueOrBuilder | Unset):
        env_name_or_builder (StringValueOrBuilder | Unset):
        org_identifier_or_builder (StringValueOrBuilder | Unset):
        project_identifier_or_builder (StringValueOrBuilder | Unset):
        parser_for_type (ParserInfraDefinitionReferenceProtoDTO | Unset):
        serialized_size (int | Unset):
        default_instance_for_type (InfraDefinitionReferenceProtoDTO | Unset):
        metadata_map (InfraDefinitionReferenceProtoDTOMetadataMap | Unset):
        initialized (bool | Unset):
        identifier (StringValue | Unset):
        initialization_error_string (str | Unset):
        all_fields (InfraDefinitionReferenceProtoDTOAllFields | Unset):
        descriptor_for_type (Descriptor | Unset):
        memoized_serialized_size (int | Unset):
    """

    unknown_fields: UnknownFieldSet | Unset = UNSET
    env_identifier: StringValue | Unset = UNSET
    ...
    env_name: StringValue | Unset = UNSET
    metadata_count: int | Unset = UNSET
    metadata: InfraDefinitionReferenceProtoDTOMetadata | Unset = UNSET
    ...
    env_identifier_or_builder: StringValueOrBuilder | Unset = UNSET
    env_name_or_builder: StringValueOrBuilder | Unset = UNSET
    org_identifier_or_builder: StringValueOrBuilder | Unset = UNSET
    project_identifier_or_builder: StringValueOrBuilder | Unset = UNSET
    parser_for_type: ParserInfraDefinitionReferenceProtoDTO | Unset = UNSET
    serialized_size: int | Unset = UNSET
    default_instance_for_type: InfraDefinitionReferenceProtoDTO | Unset = UNSET
    metadata_map: InfraDefinitionReferenceProtoDTOMetadataMap | Unset = UNSET
    initialized: bool | Unset = UNSET
    identifier: StringValue | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    all_fields: InfraDefinitionReferenceProtoDTOAllFields | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        env_identifier: dict[str, Any] | Unset = UNSET
        if not isinstance(self.env_identifier, Unset):
            env_identifier = self.env_identifier.to_dict()
        ...
        env_name: dict[str, Any] | Unset = UNSET
        if not isinstance(self.env_name, Unset):
            env_name = self.env_name.to_dict()
        ...
        env_identifier_or_builder: dict[str, Any] | Unset = UNSET
        if not isinstance(self.env_identifier_or_builder, Unset):
            env_identifier_or_builder = self.env_identifier_or_builder.to_dict()

        env_name_or_builder: dict[str, Any] | Unset = UNSET
        if not isinstance(self.env_name_or_builder, Unset):
            env_name_or_builder = self.env_name_or_builder.to_dict()
        ...
        if env_identifier_or_builder is not UNSET:
            field_dict["envIdentifierOrBuilder"] = env_identifier_or_builder
        if env_name_or_builder is not UNSET:
            field_dict["envNameOrBuilder"] = env_name_or_builder
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.infra_definition_reference_proto_dto_all_fields import InfraDefinitionReferenceProtoDTOAllFields
        from ..models.infra_definition_reference_proto_dto_metadata import InfraDefinitionReferenceProtoDTOMetadata
        from ..models.infra_definition_reference_proto_dto_metadata_map import (
        ...
        _env_identifier = d.pop("envIdentifier", UNSET)
        env_identifier: StringValue | Unset
        if isinstance(_env_identifier, Unset):
            env_identifier = UNSET
        else:
            env_identifier = StringValue.from_dict(_env_identifier)
        ...
        _env_name = d.pop("envName", UNSET)
        env_name: StringValue | Unset
        if isinstance(_env_name, Unset):
            env_name = UNSET
        else:
            env_name = StringValue.from_dict(_env_name)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = InfraDefinitionReferenceProtoDTOMetadata.from_dict(_metadata)
        ...
        _env_identifier_or_builder = d.pop("envIdentifierOrBuilder", UNSET)
        env_identifier_or_builder: StringValueOrBuilder | Unset
        if isinstance(_env_identifier_or_builder, Unset):
            env_identifier_or_builder = UNSET
        else:
            env_identifier_or_builder = StringValueOrBuilder.from_dict(_env_identifier_or_builder)

        _env_name_or_builder = d.pop("envNameOrBuilder", UNSET)
        env_name_or_builder: StringValueOrBuilder | Unset
        if isinstance(_env_name_or_builder, Unset):
            env_name_or_builder = UNSET
        else:
            env_name_or_builder = StringValueOrBuilder.from_dict(_env_name_or_builder)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserInfraDefinitionReferenceProtoDTO.from_dict(_parser_for_type)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = InfraDefinitionReferenceProtoDTO.from_dict(_default_instance_for_type)
        ...
        if isinstance(_metadata_map, Unset):
            ...
            metadata_map = InfraDefinitionReferenceProtoDTOMetadataMap.from_dict(_metadata_map)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = InfraDefinitionReferenceProtoDTOAllFields.from_dict(_all_fields)
        ...
        infra_definition_reference_proto_dto = cls(
            ...
            env_identifier_or_builder=env_identifier_or_builder,
            env_name_or_builder=env_name_or_builder,
        ...
        infra_definition_reference_proto_dto.additional_properties = d
        return infra_definition_reference_proto_dto
