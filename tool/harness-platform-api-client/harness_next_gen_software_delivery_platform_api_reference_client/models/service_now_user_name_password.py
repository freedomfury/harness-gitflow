...
T = TypeVar("T", bound="ServiceNowUserNamePassword")


@_attrs_define
class ServiceNowUserNamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_now_user_name_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        service_now_user_name_password.additional_properties = d
        return service_now_user_name_password
