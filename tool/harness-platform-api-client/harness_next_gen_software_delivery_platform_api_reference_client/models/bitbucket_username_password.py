...
T = TypeVar("T", bound="BitbucketUsernamePassword")


@_attrs_define
class BitbucketUsernamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bitbucket_username_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        bitbucket_username_password.additional_properties = d
        return bitbucket_username_password
