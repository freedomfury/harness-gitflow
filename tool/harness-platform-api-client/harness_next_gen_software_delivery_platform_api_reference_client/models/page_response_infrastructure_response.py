...
T = TypeVar("T", bound="PageResponseInfrastructureResponse")


@_attrs_define
class PageResponseInfrastructureResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[InfrastructureResponse] | Unset):
    ...
    content: list[InfrastructureResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = InfrastructureResponse.from_dict(content_item_data)
        ...
        page_response_infrastructure_response = cls(
        ...
        page_response_infrastructure_response.additional_properties = d
        return page_response_infrastructure_response
