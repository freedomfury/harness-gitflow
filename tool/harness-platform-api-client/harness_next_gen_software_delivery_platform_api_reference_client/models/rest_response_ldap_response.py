...
if TYPE_CHECKING:
    from ..models.ldap_response import LdapResponse
    from ..models.response_message import ResponseMessage
    from ..models.rest_response_ldap_response_meta_data import RestResponseLdapResponseMetaData


T = TypeVar("T", bound="RestResponseLdapResponse")


@_attrs_define
class RestResponseLdapResponse:
    """
    Attributes:
        meta_data (RestResponseLdapResponseMetaData | Unset):
        resource (LdapResponse | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseLdapResponseMetaData | Unset = UNSET
    resource: LdapResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseLdapResponseMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = LdapResponse.from_dict(_resource)
        ...
        rest_response_ldap_response = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_ldap_response.additional_properties = d
        return rest_response_ldap_response
