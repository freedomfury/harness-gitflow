...
T = TypeVar("T", bound="GithubUsernameToken")


@_attrs_define
class GithubUsernameToken:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_username_token = cls(
            token_ref=token_ref,
            username=username,
            username_ref=username_ref,
        )

        github_username_token.additional_properties = d
        return github_username_token
