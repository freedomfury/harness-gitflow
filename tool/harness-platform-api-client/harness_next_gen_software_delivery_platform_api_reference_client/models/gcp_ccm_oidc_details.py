...
T = TypeVar("T", bound="GcpCcmOidcDetails")


@_attrs_define
class GcpCcmOidcDetails:
    """This contains CCM GCP OIDC details
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gcp_ccm_oidc_details.additional_properties = d
        return gcp_ccm_oidc_details
