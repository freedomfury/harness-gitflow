...
T = TypeVar("T", bound="SumoLogicConnectorDTO")


@_attrs_define
class SumoLogicConnectorDTO:
    """
    Attributes:
        connector_type (str):
        url (str):
        ...
        field_dict.update(
            {
                ...
                "url": url,
                "accessIdRef": access_id_ref,
                "accessKeyRef": access_key_ref,
            }
        )
