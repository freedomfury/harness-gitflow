...
T = TypeVar("T", bound="PageResponseInvite")


@_attrs_define
class PageResponseInvite:
    """
    Attributes:
    ...
    content: list[Invite] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = Invite.from_dict(content_item_data)
        ...
        page_response_invite.additional_properties = d
        return page_response_invite
