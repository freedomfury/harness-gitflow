...
T = TypeVar("T", bound="InfrastructureImportResponse")


@_attrs_define
class InfrastructureImportResponse:
    """Contains info about infrastructure that is imported.

    Attributes:
        identifier (str | Unset): identifier of imported infrastructure
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        infrastructure_import_response = cls(
            identifier=identifier,
            governance_metadata=governance_metadata,
        )

        infrastructure_import_response.additional_properties = d
        return infrastructure_import_response
