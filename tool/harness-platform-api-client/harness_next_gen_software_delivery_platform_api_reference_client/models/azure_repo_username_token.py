...
T = TypeVar("T", bound="AzureRepoUsernameToken")


@_attrs_define
class AzureRepoUsernameToken:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_repo_username_token = cls(
            token_ref=token_ref,
            username=username,
            username_ref=username_ref,
        )

        azure_repo_username_token.additional_properties = d
        return azure_repo_username_token
