...
T = TypeVar("T", bound="GithubEnterpriseProviderRequestInfo")


@_attrs_define
class GithubEnterpriseProviderRequestInfo:
    """
    Attributes:
        type_ (str):
        domain (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_enterprise_provider_request_info = cls(
            type_=type_,
            domain=domain,
        ...
        github_enterprise_provider_request_info.additional_properties = d
        return github_enterprise_provider_request_info
