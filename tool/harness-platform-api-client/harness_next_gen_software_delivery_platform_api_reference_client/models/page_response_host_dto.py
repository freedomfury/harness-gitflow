...
T = TypeVar("T", bound="PageResponseHostDTO")


@_attrs_define
class PageResponseHostDTO:
    """
    Attributes:
    ...
    content: list[HostDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = HostDTO.from_dict(content_item_data)
        ...
        page_response_host_dto.additional_properties = d
        return page_response_host_dto
