...
GitSyncErrorEntityType = Literal[
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
GIT_SYNC_ERROR_ENTITY_TYPE_VALUES: set[GitSyncErrorEntityType] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_git_sync_error_entity_type(value: str) -> GitSyncErrorEntityType:
    if value in GIT_SYNC_ERROR_ENTITY_TYPE_VALUES:
        return cast(GitSyncErrorEntityType, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {GIT_SYNC_ERROR_ENTITY_TYPE_VALUES!r}")
