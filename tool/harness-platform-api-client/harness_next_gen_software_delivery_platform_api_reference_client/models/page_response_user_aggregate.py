...
T = TypeVar("T", bound="PageResponseUserAggregate")


@_attrs_define
class PageResponseUserAggregate:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[UserAggregate] | Unset):
    ...
    content: list[UserAggregate] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = UserAggregate.from_dict(content_item_data)
        ...
        page_response_user_aggregate = cls(
        ...
        page_response_user_aggregate.additional_properties = d
        return page_response_user_aggregate
