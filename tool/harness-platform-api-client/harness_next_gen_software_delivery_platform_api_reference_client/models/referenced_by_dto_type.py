...
REFERENCED_BY_DTO_TYPE_VALUES: set[ReferencedByDTOType] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_referenced_by_dto_type(value: str) -> ReferencedByDTOType:
    if value in REFERENCED_BY_DTO_TYPE_VALUES:
        return cast(ReferencedByDTOType, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {REFERENCED_BY_DTO_TYPE_VALUES!r}")
