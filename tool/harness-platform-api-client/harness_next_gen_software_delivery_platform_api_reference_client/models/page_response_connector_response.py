...
T = TypeVar("T", bound="PageResponseConnectorResponse")


@_attrs_define
class PageResponseConnectorResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ConnectorResponse] | Unset):
    ...
    content: list[ConnectorResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ConnectorResponse.from_dict(content_item_data)
        ...
        page_response_connector_response = cls(
        ...
        page_response_connector_response.additional_properties = d
        return page_response_connector_response
