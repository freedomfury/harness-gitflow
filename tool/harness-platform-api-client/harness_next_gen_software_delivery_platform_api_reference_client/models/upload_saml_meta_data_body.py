...
if TYPE_CHECKING:
    ...
    from ..models.upload_saml_meta_data_body_file import UploadSamlMetaDataBodyFile


T = TypeVar("T", bound="UploadSamlMetaDataBody")


@_attrs_define
class UploadSamlMetaDataBody:
    """
    Attributes:
        file (UploadSamlMetaDataBodyFile | Unset): Saml Metadata input file
    ...
    file: UploadSamlMetaDataBodyFile | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file: UploadSamlMetaDataBodyFile | Unset
        if isinstance(_file, Unset):
            file = UNSET
        else:
            file = UploadSamlMetaDataBodyFile.from_dict(_file)
        ...
        upload_saml_meta_data_body = cls(
            file=file,
        ...
        upload_saml_meta_data_body.additional_properties = d
        return upload_saml_meta_data_body
