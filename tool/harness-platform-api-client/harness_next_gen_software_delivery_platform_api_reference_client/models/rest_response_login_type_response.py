...
if TYPE_CHECKING:
    from ..models.login_type_response import LoginTypeResponse
    from ..models.response_message import ResponseMessage
    from ..models.rest_response_login_type_response_meta_data import RestResponseLoginTypeResponseMetaData


T = TypeVar("T", bound="RestResponseLoginTypeResponse")


@_attrs_define
class RestResponseLoginTypeResponse:
    """
    Attributes:
        meta_data (RestResponseLoginTypeResponseMetaData | Unset):
        resource (LoginTypeResponse | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseLoginTypeResponseMetaData | Unset = UNSET
    resource: LoginTypeResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseLoginTypeResponseMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = LoginTypeResponse.from_dict(_resource)
        ...
        rest_response_login_type_response = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_login_type_response.additional_properties = d
        return rest_response_login_type_response
