...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_agent_mtls_endpoint_details_meta_data import (
        RestResponseAgentMtlsEndpointDetailsMetaData,
    )


T = TypeVar("T", bound="RestResponseAgentMtlsEndpointDetails")


@_attrs_define
class RestResponseAgentMtlsEndpointDetails:
    """
    Attributes:
        meta_data (RestResponseAgentMtlsEndpointDetailsMetaData | Unset):
        resource (AgentMtlsEndpointDetails | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseAgentMtlsEndpointDetailsMetaData | Unset = UNSET
    resource: AgentMtlsEndpointDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseAgentMtlsEndpointDetailsMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = AgentMtlsEndpointDetails.from_dict(_resource)
        ...
        rest_response_agent_mtls_endpoint_details = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_agent_mtls_endpoint_details.additional_properties = d
        return rest_response_agent_mtls_endpoint_details
