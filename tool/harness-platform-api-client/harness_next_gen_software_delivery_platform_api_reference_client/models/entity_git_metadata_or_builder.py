...
if TYPE_CHECKING:
    ...
    from ..models.entity_git_metadata_or_builder_all_fields import EntityGitMetadataOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="EntityGitMetadataOrBuilder")


@_attrs_define
class EntityGitMetadataOrBuilder:
    """
    Attributes:
        repo (str | Unset):
        branch (str | Unset):
        ...
        all_fields (EntityGitMetadataOrBuilderAllFields | Unset):
    ...
    all_fields: EntityGitMetadataOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = EntityGitMetadataOrBuilderAllFields.from_dict(_all_fields)
        ...
        entity_git_metadata_or_builder = cls(
            repo=repo,
            branch=branch,
        ...
        entity_git_metadata_or_builder.additional_properties = d
        return entity_git_metadata_or_builder
