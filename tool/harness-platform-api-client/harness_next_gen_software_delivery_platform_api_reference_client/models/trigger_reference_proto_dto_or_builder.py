...
if TYPE_CHECKING:
    ...
    from ..models.trigger_reference_proto_dto_or_builder_all_fields import TriggerReferenceProtoDTOOrBuilderAllFields
    from ..models.trigger_reference_proto_dto_or_builder_metadata import TriggerReferenceProtoDTOOrBuilderMetadata
    from ..models.trigger_reference_proto_dto_or_builder_metadata_map import (
        TriggerReferenceProtoDTOOrBuilderMetadataMap,
    )
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="TriggerReferenceProtoDTOOrBuilder")


@_attrs_define
class TriggerReferenceProtoDTOOrBuilder:
    """
    Attributes:
        ...
        metadata (TriggerReferenceProtoDTOOrBuilderMetadata | Unset):
        ...
        metadata_map (TriggerReferenceProtoDTOOrBuilderMetadataMap | Unset):
        identifier (StringValue | Unset):
        initialization_error_string (str | Unset):
        all_fields (TriggerReferenceProtoDTOOrBuilderAllFields | Unset):
    ...
    metadata: TriggerReferenceProtoDTOOrBuilderMetadata | Unset = UNSET
    ...
    metadata_map: TriggerReferenceProtoDTOOrBuilderMetadataMap | Unset = UNSET
    identifier: StringValue | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    all_fields: TriggerReferenceProtoDTOOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.string_value import StringValue
        from ..models.string_value_or_builder import StringValueOrBuilder
        from ..models.trigger_reference_proto_dto_or_builder_all_fields import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = TriggerReferenceProtoDTOOrBuilderMetadata.from_dict(_metadata)
        ...
        if isinstance(_metadata_map, Unset):
            ...
            metadata_map = TriggerReferenceProtoDTOOrBuilderMetadataMap.from_dict(_metadata_map)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = TriggerReferenceProtoDTOOrBuilderAllFields.from_dict(_all_fields)
        ...
        trigger_reference_proto_dto_or_builder = cls(
        ...
        trigger_reference_proto_dto_or_builder.additional_properties = d
        return trigger_reference_proto_dto_or_builder
