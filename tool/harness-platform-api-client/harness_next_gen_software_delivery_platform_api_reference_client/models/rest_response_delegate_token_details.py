...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_delegate_token_details_meta_data import RestResponseDelegateTokenDetailsMetaData


T = TypeVar("T", bound="RestResponseDelegateTokenDetails")


@_attrs_define
class RestResponseDelegateTokenDetails:
    """
    Attributes:
        meta_data (RestResponseDelegateTokenDetailsMetaData | Unset):
        resource (DelegateTokenDetails | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseDelegateTokenDetailsMetaData | Unset = UNSET
    resource: DelegateTokenDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseDelegateTokenDetailsMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DelegateTokenDetails.from_dict(_resource)
        ...
        rest_response_delegate_token_details = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_delegate_token_details.additional_properties = d
        return rest_response_delegate_token_details
