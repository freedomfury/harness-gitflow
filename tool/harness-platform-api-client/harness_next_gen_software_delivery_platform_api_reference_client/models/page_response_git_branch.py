...
T = TypeVar("T", bound="PageResponseGitBranch")


@_attrs_define
class PageResponseGitBranch:
    ...
    content: list[GitBranch] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GitBranch.from_dict(content_item_data)
        ...
        page_response_git_branch.additional_properties = d
        return page_response_git_branch
