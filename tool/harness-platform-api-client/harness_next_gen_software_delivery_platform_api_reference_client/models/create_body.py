...
from .. import types
from ..models.create_body_type import CreateBodyType, check_create_body_type
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_body_content import CreateBodyContent
    from ..models.embedded_user_details_dto import EmbeddedUserDetailsDTO


T = TypeVar("T", bound="CreateBody")
...
class CreateBody:
    ...
    Attributes:
        ...
        type_ (CreateBodyType): This specifies the type of the File
        ...
        content (CreateBodyContent | Unset): The content of the File as InputStream
    ...
    name: str
    type_: CreateBodyType
    parent_identifier: str
    tags: str | Unset = UNSET
    content: CreateBodyContent | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_create_body_type(d.pop("type"))
        ...
        content: CreateBodyContent | Unset
        if isinstance(_content, Unset):
            content = UNSET
        else:
            content = CreateBodyContent.from_dict(_content)
        ...
        create_body.additional_properties = d
        return create_body
