...
T = TypeVar("T", bound="ProviderRequestInfo")


@_attrs_define
class ProviderRequestInfo:
    """Spec of the Provider
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_request_info.additional_properties = d
        return provider_request_info
