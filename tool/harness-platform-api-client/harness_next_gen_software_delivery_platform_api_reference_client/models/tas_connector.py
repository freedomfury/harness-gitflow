...
if TYPE_CHECKING:
    from ..models.tas_credential import TasCredential


T = TypeVar("T", bound="TasConnector")
...
class TasConnector:
    ...
    Attributes:
        connector_type (str):
        credential (TasCredential): This contains Tas connector credentials
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credential = TasCredential.from_dict(d.pop("credential"))
        ...
        tas_connector.additional_properties = d
        return tas_connector
