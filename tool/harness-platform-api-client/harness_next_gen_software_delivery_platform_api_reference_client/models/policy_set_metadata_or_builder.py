...
if TYPE_CHECKING:
    ...
    from ..models.policy_set_metadata_or_builder_all_fields import PolicySetMetadataOrBuilderAllFields
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="PolicySetMetadataOrBuilder")


@_attrs_define
class PolicySetMetadataOrBuilder:
    """
    Attributes:
        ...
        all_fields (PolicySetMetadataOrBuilderAllFields | Unset):
    ...
    all_fields: PolicySetMetadataOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = PolicySetMetadataOrBuilderAllFields.from_dict(_all_fields)
        ...
        policy_set_metadata_or_builder = cls(
        ...
        policy_set_metadata_or_builder.additional_properties = d
        return policy_set_metadata_or_builder
