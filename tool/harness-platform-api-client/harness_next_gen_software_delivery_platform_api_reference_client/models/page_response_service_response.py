...
T = TypeVar("T", bound="PageResponseServiceResponse")


@_attrs_define
class PageResponseServiceResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ServiceResponse] | Unset):
    ...
    content: list[ServiceResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServiceResponse.from_dict(content_item_data)
        ...
        page_response_service_response = cls(
        ...
        page_response_service_response.additional_properties = d
        return page_response_service_response
