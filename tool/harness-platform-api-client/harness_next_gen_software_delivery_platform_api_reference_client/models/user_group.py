...
if TYPE_CHECKING:
    ...
    from ..models.user_group_tags import UserGroupTags
...
class UserGroup:
    ...
    Attributes:
        ...
        users (list[str] | Unset): List of users ids in the UserGroup.
    ...
    tags: UserGroupTags | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tags: UserGroupTags | Unset
        if isinstance(_tags, Unset):
            tags = UNSET
        else:
            tags = UserGroupTags.from_dict(_tags)
