...
if TYPE_CHECKING:
    from ..models.spot_credential import SpotCredential


T = TypeVar("T", bound="SpotConnector")
...
class SpotConnector:
    ...
    Attributes:
        connector_type (str):
        credential (SpotCredential): This contains details of the Spot connector credential
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credential = SpotCredential.from_dict(d.pop("credential"))
        ...
        spot_connector.additional_properties = d
