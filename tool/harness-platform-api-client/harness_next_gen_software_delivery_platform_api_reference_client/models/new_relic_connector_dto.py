...
T = TypeVar("T", bound="NewRelicConnectorDTO")


@_attrs_define
class NewRelicConnectorDTO:
    """
    Attributes:
        connector_type (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        new_relic_account_id = self.new_relic_account_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_relic_account_id = d.pop("newRelicAccountId")
        ...
        new_relic_connector_dto.additional_properties = d
        return new_relic_connector_dto
