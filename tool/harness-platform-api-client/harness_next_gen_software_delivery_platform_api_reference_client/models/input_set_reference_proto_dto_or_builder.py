...
if TYPE_CHECKING:
    ...
    from ..models.input_set_reference_proto_dto_or_builder_all_fields import InputSetReferenceProtoDTOOrBuilderAllFields
...
T = TypeVar("T", bound="InputSetReferenceProtoDTOOrBuilder")


@_attrs_define
class InputSetReferenceProtoDTOOrBuilder:
    """
    Attributes:
        ...
        all_fields (InputSetReferenceProtoDTOOrBuilderAllFields | Unset):
    ...
    all_fields: InputSetReferenceProtoDTOOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.descriptor import Descriptor
        from ..models.input_set_reference_proto_dto_or_builder_all_fields import (
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = InputSetReferenceProtoDTOOrBuilderAllFields.from_dict(_all_fields)
        ...
        input_set_reference_proto_dto_or_builder = cls(
        ...
        input_set_reference_proto_dto_or_builder.additional_properties = d
        return input_set_reference_proto_dto_or_builder
