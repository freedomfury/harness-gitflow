...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_list_delegate_group_dto_meta_data import RestResponseListDelegateGroupDTOMetaData


T = TypeVar("T", bound="RestResponseListDelegateGroupDTO")


@_attrs_define
class RestResponseListDelegateGroupDTO:
    """
    Attributes:
        meta_data (RestResponseListDelegateGroupDTOMetaData | Unset):
        resource (list[DelegateGroupDTO] | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseListDelegateGroupDTOMetaData | Unset = UNSET
    resource: list[DelegateGroupDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseListDelegateGroupDTOMetaData.from_dict(_meta_data)
        ...
        if _resource is not UNSET:
            ...
            for resource_item_data in _resource:
                resource_item = DelegateGroupDTO.from_dict(resource_item_data)
        ...
        rest_response_list_delegate_group_dto = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_list_delegate_group_dto.additional_properties = d
        return rest_response_list_delegate_group_dto
