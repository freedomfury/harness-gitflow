...
from ..models.template_reference_proto_dto_scope import (
    TemplateReferenceProtoDTOScope,
    check_template_reference_proto_dto_scope,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.descriptor import Descriptor
    from ..models.parser_template_reference_proto_dto import ParserTemplateReferenceProtoDTO
    from ..models.string_value import StringValue
    from ..models.string_value_or_builder import StringValueOrBuilder
    from ..models.template_reference_proto_dto_all_fields import TemplateReferenceProtoDTOAllFields
    from ..models.template_reference_proto_dto_metadata import TemplateReferenceProtoDTOMetadata
    from ..models.template_reference_proto_dto_metadata_map import TemplateReferenceProtoDTOMetadataMap
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="TemplateReferenceProtoDTO")


@_attrs_define
class TemplateReferenceProtoDTO:
    """
    Attributes:
        ...
        metadata (TemplateReferenceProtoDTOMetadata | Unset):
        ...
        parser_for_type (ParserTemplateReferenceProtoDTO | Unset):
        serialized_size (int | Unset):
        version_label (StringValue | Unset):
        default_instance_for_type (TemplateReferenceProtoDTO | Unset):
        metadata_map (TemplateReferenceProtoDTOMetadataMap | Unset):
        initialized (bool | Unset):
        identifier (StringValue | Unset):
        scope (TemplateReferenceProtoDTOScope | Unset):
        initialization_error_string (str | Unset):
        all_fields (TemplateReferenceProtoDTOAllFields | Unset):
    ...
    metadata: TemplateReferenceProtoDTOMetadata | Unset = UNSET
    ...
    parser_for_type: ParserTemplateReferenceProtoDTO | Unset = UNSET
    serialized_size: int | Unset = UNSET
    version_label: StringValue | Unset = UNSET
    default_instance_for_type: TemplateReferenceProtoDTO | Unset = UNSET
    metadata_map: TemplateReferenceProtoDTOMetadataMap | Unset = UNSET
    initialized: bool | Unset = UNSET
    identifier: StringValue | Unset = UNSET
    scope: TemplateReferenceProtoDTOScope | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    all_fields: TemplateReferenceProtoDTOAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = TemplateReferenceProtoDTOMetadata.from_dict(_metadata)
        ...
        if isinstance(_parser_for_type, Unset):
            ...
            parser_for_type = ParserTemplateReferenceProtoDTO.from_dict(_parser_for_type)
        ...
        if isinstance(_default_instance_for_type, Unset):
            ...
            default_instance_for_type = TemplateReferenceProtoDTO.from_dict(_default_instance_for_type)
        ...
        if isinstance(_metadata_map, Unset):
            ...
            metadata_map = TemplateReferenceProtoDTOMetadataMap.from_dict(_metadata_map)
        ...
        if isinstance(_scope, Unset):
            ...
            scope = check_template_reference_proto_dto_scope(_scope)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = TemplateReferenceProtoDTOAllFields.from_dict(_all_fields)
        ...
        template_reference_proto_dto = cls(
        ...
        template_reference_proto_dto.additional_properties = d
        return template_reference_proto_dto
