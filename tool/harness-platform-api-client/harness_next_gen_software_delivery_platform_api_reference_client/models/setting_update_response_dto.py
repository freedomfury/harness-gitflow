...
T = TypeVar("T", bound="SettingUpdateResponseDTO")


@_attrs_define
class SettingUpdateResponseDTO:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        setting_update_response_dto = cls(
            identifier=identifier,
            setting=setting,
        ...
        setting_update_response_dto.additional_properties = d
        return setting_update_response_dto
