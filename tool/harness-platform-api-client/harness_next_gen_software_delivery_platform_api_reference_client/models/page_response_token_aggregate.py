...
if TYPE_CHECKING:
    from ..models.token_aggregate import TokenAggregate


T = TypeVar("T", bound="PageResponseTokenAggregate")


@_attrs_define
class PageResponseTokenAggregate:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[TokenAggregate] | Unset):
    ...
    content: list[TokenAggregate] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = TokenAggregate.from_dict(content_item_data)
        ...
        page_response_token_aggregate = cls(
        ...
        page_response_token_aggregate.additional_properties = d
        return page_response_token_aggregate
