...
T = TypeVar("T", bound="PageResponseServiceOverrideResponse")


@_attrs_define
class PageResponseServiceOverrideResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ServiceOverrideResponse] | Unset):
    ...
    content: list[ServiceOverrideResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServiceOverrideResponse.from_dict(content_item_data)
        ...
        page_response_service_override_response = cls(
        ...
        page_response_service_override_response.additional_properties = d
        return page_response_service_override_response
