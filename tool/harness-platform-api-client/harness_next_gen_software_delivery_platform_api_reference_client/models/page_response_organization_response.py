...
T = TypeVar("T", bound="PageResponseOrganizationResponse")


@_attrs_define
class PageResponseOrganizationResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[OrganizationResponse] | Unset):
    ...
    content: list[OrganizationResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = OrganizationResponse.from_dict(content_item_data)
        ...
        page_response_organization_response = cls(
        ...
        page_response_organization_response.additional_properties = d
        return page_response_organization_response
