...
if TYPE_CHECKING:
    from ..models.ccm_k8s_connector_response import CcmK8SConnectorResponse


T = TypeVar("T", bound="PageResponseCcmK8SConnectorResponse")


@_attrs_define
class PageResponseCcmK8SConnectorResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[CcmK8SConnectorResponse] | Unset):
    ...
    content: list[CcmK8SConnectorResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = CcmK8SConnectorResponse.from_dict(content_item_data)
        ...
        page_response_ccm_k8s_connector_response = cls(
        ...
        page_response_ccm_k8s_connector_response.additional_properties = d
        return page_response_ccm_k8s_connector_response
