...
T = TypeVar("T", bound="GitHTTPAuthenticationDTO")


@_attrs_define
class GitHTTPAuthenticationDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        git_http_authentication_dto = cls(
            type_=type_,
        ...
        git_http_authentication_dto.additional_properties = d
        return git_http_authentication_dto
