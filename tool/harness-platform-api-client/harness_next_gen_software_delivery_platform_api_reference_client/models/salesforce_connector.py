...
if TYPE_CHECKING:
    from ..models.salesforce_credential import SalesforceCredential


T = TypeVar("T", bound="SalesforceConnector")
...
class SalesforceConnector:
    ...
    Attributes:
        connector_type (str):
        credential (SalesforceCredential): This contains Salesforce connector credentials
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credential = SalesforceCredential.from_dict(d.pop("credential"))
        ...
        salesforce_connector.additional_properties = d
        return salesforce_connector
