...
from ..models.ms_teams_connector_api_access_type import (
    MsTeamsConnectorApiAccessType,
    check_ms_teams_connector_api_access_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MsTeamsConnector")
...
class MsTeamsConnector:
    ...
    Attributes:
        connector_type (str):
        api_access_type (MsTeamsConnectorApiAccessType):
        tenant_id (str | Unset):
        client_id (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_access_type = check_ms_teams_connector_api_access_type(d.pop("apiAccessType"))
        ...
        ms_teams_connector.additional_properties = d
        return ms_teams_connector
