...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_string_meta_data import RestResponseStringMetaData


T = TypeVar("T", bound="RestResponseString")


@_attrs_define
class RestResponseString:
    """
    Attributes:
        meta_data (RestResponseStringMetaData | Unset):
        resource (str | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseStringMetaData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseStringMetaData.from_dict(_meta_data)
        ...
        rest_response_string = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_string.additional_properties = d
        return rest_response_string
