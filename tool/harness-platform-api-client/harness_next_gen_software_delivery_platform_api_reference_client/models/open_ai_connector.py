...
if TYPE_CHECKING:
    from ..models.open_ai_authentication_dto import OpenAIAuthenticationDTO


T = TypeVar("T", bound="OpenAIConnector")
...
class OpenAIConnector:
    ...
    Attributes:
        connector_type (str):
        authentication (OpenAIAuthenticationDTO): This entity contains the details for OpenAI Authentication
        base_url (str | Unset):
    ...
    connector_type: str
    authentication: OpenAIAuthenticationDTO
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication = OpenAIAuthenticationDTO.from_dict(d.pop("authentication"))
        ...
        open_ai_connector.additional_properties = d
        return open_ai_connector
