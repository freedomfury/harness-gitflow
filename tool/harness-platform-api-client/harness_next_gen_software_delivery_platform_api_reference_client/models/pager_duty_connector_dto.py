...
T = TypeVar("T", bound="PagerDutyConnectorDTO")


@_attrs_define
class PagerDutyConnectorDTO:
    """
    Attributes:
        connector_type (str):
        api_token_ref (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pager_duty_connector_dto.additional_properties = d
        return pager_duty_connector_dto
