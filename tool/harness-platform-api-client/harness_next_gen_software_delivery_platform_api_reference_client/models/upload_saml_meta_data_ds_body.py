...
if TYPE_CHECKING:
    ...
    from ..models.upload_saml_meta_data_ds_body_file import UploadSamlMetaDataDsBodyFile


T = TypeVar("T", bound="UploadSamlMetaDataDsBody")


@_attrs_define
class UploadSamlMetaDataDsBody:
    """
    Attributes:
        file (UploadSamlMetaDataDsBodyFile | Unset): Saml Metadata input file
    ...
    file: UploadSamlMetaDataDsBodyFile | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file: UploadSamlMetaDataDsBodyFile | Unset
        if isinstance(_file, Unset):
            file = UNSET
        else:
            file = UploadSamlMetaDataDsBodyFile.from_dict(_file)
        ...
        upload_saml_meta_data_ds_body = cls(
            file=file,
        ...
        upload_saml_meta_data_ds_body.additional_properties = d
        return upload_saml_meta_data_ds_body
