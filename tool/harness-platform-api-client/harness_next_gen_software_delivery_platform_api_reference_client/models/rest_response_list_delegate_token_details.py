...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_list_delegate_token_details_meta_data import (
        RestResponseListDelegateTokenDetailsMetaData,
    )


T = TypeVar("T", bound="RestResponseListDelegateTokenDetails")


@_attrs_define
class RestResponseListDelegateTokenDetails:
    """
    Attributes:
        meta_data (RestResponseListDelegateTokenDetailsMetaData | Unset):
        resource (list[DelegateTokenDetails] | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseListDelegateTokenDetailsMetaData | Unset = UNSET
    resource: list[DelegateTokenDetails] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseListDelegateTokenDetailsMetaData.from_dict(_meta_data)
        ...
        if _resource is not UNSET:
            ...
            for resource_item_data in _resource:
                resource_item = DelegateTokenDetails.from_dict(resource_item_data)
        ...
        rest_response_list_delegate_token_details = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_list_delegate_token_details.additional_properties = d
        return rest_response_list_delegate_token_details
