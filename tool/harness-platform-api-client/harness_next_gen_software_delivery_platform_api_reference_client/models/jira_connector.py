...
if TYPE_CHECKING:
    from ..models.jira_authentication import JiraAuthentication


T = TypeVar("T", bound="JiraConnector")
...
class JiraConnector:
    ...
    Attributes:
        connector_type (str):
        jira_url (str):
        auth (JiraAuthentication): This entity contains the details for Jira Authentication
        username (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jira_url = d.pop("jiraUrl")

        auth = JiraAuthentication.from_dict(d.pop("auth"))
        ...
        jira_connector.additional_properties = d
