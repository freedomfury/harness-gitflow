...
T = TypeVar("T", bound="GithubSshCredentials")


@_attrs_define
class GithubSshCredentials:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_ssh_credentials = cls(
            ssh_key_ref=ssh_key_ref,
        )

        github_ssh_credentials.additional_properties = d
        return github_ssh_credentials
