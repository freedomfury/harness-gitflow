...
T = TypeVar("T", bound="PageResponseEnvironmentGroup")


@_attrs_define
class PageResponseEnvironmentGroup:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[EnvironmentGroup] | Unset):
    ...
    content: list[EnvironmentGroup] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = EnvironmentGroup.from_dict(content_item_data)
        ...
        page_response_environment_group = cls(
        ...
        page_response_environment_group.additional_properties = d
        return page_response_environment_group
