...
T = TypeVar("T", bound="NexusUsernamePasswordAuth")


@_attrs_define
class NexusUsernamePasswordAuth:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nexus_username_password_auth = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        nexus_username_password_auth.additional_properties = d
        return nexus_username_password_auth
