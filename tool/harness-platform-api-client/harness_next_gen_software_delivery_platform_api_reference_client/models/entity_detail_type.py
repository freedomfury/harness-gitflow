...
ENTITY_DETAIL_TYPE_VALUES: set[EntityDetailType] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_entity_detail_type(value: str) -> EntityDetailType:
    if value in ENTITY_DETAIL_TYPE_VALUES:
        return cast(EntityDetailType, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {ENTITY_DETAIL_TYPE_VALUES!r}")
