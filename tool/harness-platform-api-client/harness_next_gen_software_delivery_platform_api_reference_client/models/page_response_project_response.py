...
T = TypeVar("T", bound="PageResponseProjectResponse")


@_attrs_define
class PageResponseProjectResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ProjectResponse] | Unset):
    ...
    content: list[ProjectResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ProjectResponse.from_dict(content_item_data)
        ...
        page_response_project_response = cls(
        ...
        page_response_project_response.additional_properties = d
        return page_response_project_response
