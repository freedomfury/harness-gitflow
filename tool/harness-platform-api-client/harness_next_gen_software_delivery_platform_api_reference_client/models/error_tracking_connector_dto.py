...
T = TypeVar("T", bound="ErrorTrackingConnectorDTO")


@_attrs_define
class ErrorTrackingConnectorDTO:
    """
    Attributes:
        connector_type (str):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        error_tracking_connector_dto = cls(
        ...
        error_tracking_connector_dto.additional_properties = d
        return error_tracking_connector_dto
