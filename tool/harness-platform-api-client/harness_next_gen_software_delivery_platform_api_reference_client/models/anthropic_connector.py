...
if TYPE_CHECKING:
    from ..models.anthropic_authentication_dto import AnthropicAuthenticationDTO


T = TypeVar("T", bound="AnthropicConnector")
...
class AnthropicConnector:
    ...
    Attributes:
        connector_type (str):
        authentication (AnthropicAuthenticationDTO): This entity contains the details for Anthropic Authentication
        url (str | Unset):
    ...
    connector_type: str
    authentication: AnthropicAuthenticationDTO
    url: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        authentication = AnthropicAuthenticationDTO.from_dict(d.pop("authentication"))
        ...
        anthropic_connector.additional_properties = d
        return anthropic_connector
