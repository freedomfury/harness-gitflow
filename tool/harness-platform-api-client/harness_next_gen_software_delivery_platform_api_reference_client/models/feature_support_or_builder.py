...
from ..models.feature_support_or_builder_edition_deprecated import (
    FeatureSupportOrBuilderEditionDeprecated,
    check_feature_support_or_builder_edition_deprecated,
)
from ..models.feature_support_or_builder_edition_introduced import (
    FeatureSupportOrBuilderEditionIntroduced,
    check_feature_support_or_builder_edition_introduced,
)
from ..models.feature_support_or_builder_edition_removed import (
    FeatureSupportOrBuilderEditionRemoved,
    check_feature_support_or_builder_edition_removed,
)
...
if TYPE_CHECKING:
    ...
    from ..models.feature_support_or_builder_all_fields import FeatureSupportOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="FeatureSupportOrBuilder")


@_attrs_define
class FeatureSupportOrBuilder:
    """
    Attributes:
        edition_introduced (FeatureSupportOrBuilderEditionIntroduced | Unset):
        edition_deprecated (FeatureSupportOrBuilderEditionDeprecated | Unset):
        deprecation_warning (str | Unset):
        deprecation_warning_bytes (ByteString | Unset):
        edition_removed (FeatureSupportOrBuilderEditionRemoved | Unset):
        initialization_error_string (str | Unset):
        all_fields (FeatureSupportOrBuilderAllFields | Unset):
    ...
    edition_introduced: FeatureSupportOrBuilderEditionIntroduced | Unset = UNSET
    edition_deprecated: FeatureSupportOrBuilderEditionDeprecated | Unset = UNSET
    deprecation_warning: str | Unset = UNSET
    deprecation_warning_bytes: ByteString | Unset = UNSET
    edition_removed: FeatureSupportOrBuilderEditionRemoved | Unset = UNSET
    initialization_error_string: str | Unset = UNSET
    all_fields: FeatureSupportOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_edition_introduced, Unset):
            ...
            edition_introduced = check_feature_support_or_builder_edition_introduced(_edition_introduced)
        ...
        if isinstance(_edition_deprecated, Unset):
            ...
            edition_deprecated = check_feature_support_or_builder_edition_deprecated(_edition_deprecated)
        ...
        if isinstance(_edition_removed, Unset):
            ...
            edition_removed = check_feature_support_or_builder_edition_removed(_edition_removed)
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = FeatureSupportOrBuilderAllFields.from_dict(_all_fields)
        ...
        feature_support_or_builder = cls(
        ...
        feature_support_or_builder.additional_properties = d
        return feature_support_or_builder
