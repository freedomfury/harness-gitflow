...
GitFullSyncEntityInfoFilterEntityTypesItem = Literal[
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
GIT_FULL_SYNC_ENTITY_INFO_FILTER_ENTITY_TYPES_ITEM_VALUES: set[GitFullSyncEntityInfoFilterEntityTypesItem] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_git_full_sync_entity_info_filter_entity_types_item(value: str) -> GitFullSyncEntityInfoFilterEntityTypesItem:
    if value in GIT_FULL_SYNC_ENTITY_INFO_FILTER_ENTITY_TYPES_ITEM_VALUES:
        return cast(GitFullSyncEntityInfoFilterEntityTypesItem, value)
    raise TypeError(
        f"Unexpected value {value!r}. Expected one of {GIT_FULL_SYNC_ENTITY_INFO_FILTER_ENTITY_TYPES_ITEM_VALUES!r}"
    )
