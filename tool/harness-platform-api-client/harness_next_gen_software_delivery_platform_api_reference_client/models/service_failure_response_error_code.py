...
ServiceFailureResponseErrorCode = Literal[
    "ABORT_ALL_ALREADY",
...
SERVICE_FAILURE_RESPONSE_ERROR_CODE_VALUES: set[ServiceFailureResponseErrorCode] = {
    "ABORT_ALL_ALREADY",
    "ABORT_ALL_ALREADY_NG",
    "ACCESS_DENIED",
    "ACCOUNT_DISABLED",
...
def check_service_failure_response_error_code(value: str) -> ServiceFailureResponseErrorCode:
    if value in SERVICE_FAILURE_RESPONSE_ERROR_CODE_VALUES:
        return cast(ServiceFailureResponseErrorCode, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {SERVICE_FAILURE_RESPONSE_ERROR_CODE_VALUES!r}")
