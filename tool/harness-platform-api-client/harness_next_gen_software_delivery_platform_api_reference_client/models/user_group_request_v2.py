...
if TYPE_CHECKING:
    ...
    from ..models.user_group_request_v2_tags import UserGroupRequestV2Tags


T = TypeVar("T", bound="UserGroupRequestV2")


@_attrs_define
class UserGroupRequestV2:
    ...
    Attributes:
        ...
        users (list[str] | Unset): List of users emails in the UserGroup. Maximum users can be 5000.
        ...
        tags (UserGroupRequestV2Tags | Unset): Tags
    ...
    tags: UserGroupRequestV2Tags | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tags: UserGroupRequestV2Tags | Unset
        if isinstance(_tags, Unset):
            tags = UNSET
        else:
            tags = UserGroupRequestV2Tags.from_dict(_tags)

        harness_managed = d.pop("harnessManaged", UNSET)

        sso_linked = d.pop("ssoLinked", UNSET)

        user_group_request_v2 = cls(
            identifier=identifier,
            name=name,
        ...
        user_group_request_v2.additional_properties = d
        return user_group_request_v2
