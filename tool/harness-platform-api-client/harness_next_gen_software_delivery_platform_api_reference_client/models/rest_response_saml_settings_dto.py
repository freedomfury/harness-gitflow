...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_saml_settings_dto_meta_data import RestResponseSamlSettingsDTOMetaData
    from ..models.saml_settings_dto import SamlSettingsDTO


T = TypeVar("T", bound="RestResponseSamlSettingsDTO")


@_attrs_define
class RestResponseSamlSettingsDTO:
    """
    Attributes:
        meta_data (RestResponseSamlSettingsDTOMetaData | Unset):
        resource (SamlSettingsDTO | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseSamlSettingsDTOMetaData | Unset = UNSET
    resource: SamlSettingsDTO | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseSamlSettingsDTOMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = SamlSettingsDTO.from_dict(_resource)
        ...
        rest_response_saml_settings_dto = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_saml_settings_dto.additional_properties = d
        return rest_response_saml_settings_dto
