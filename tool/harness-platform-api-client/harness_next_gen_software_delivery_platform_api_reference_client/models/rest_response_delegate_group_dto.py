...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_delegate_group_dto_meta_data import RestResponseDelegateGroupDTOMetaData


T = TypeVar("T", bound="RestResponseDelegateGroupDTO")


@_attrs_define
class RestResponseDelegateGroupDTO:
    """
    Attributes:
        meta_data (RestResponseDelegateGroupDTOMetaData | Unset):
        resource (DelegateGroupDTO | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseDelegateGroupDTOMetaData | Unset = UNSET
    resource: DelegateGroupDTO | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseDelegateGroupDTOMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DelegateGroupDTO.from_dict(_resource)
        ...
        rest_response_delegate_group_dto = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_delegate_group_dto.additional_properties = d
        return rest_response_delegate_group_dto
