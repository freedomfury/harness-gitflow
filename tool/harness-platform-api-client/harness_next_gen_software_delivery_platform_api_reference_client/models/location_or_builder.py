...
if TYPE_CHECKING:
    ...
    from ..models.location_or_builder_all_fields import LocationOrBuilderAllFields
    from ..models.message import Message
    from ..models.unknown_field_set import UnknownFieldSet


T = TypeVar("T", bound="LocationOrBuilder")
...
class LocationOrBuilder:
    ...
    Attributes:
        ...
        all_fields (LocationOrBuilderAllFields | Unset):
    ...
    all_fields: LocationOrBuilderAllFields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_all_fields, Unset):
            ...
            all_fields = LocationOrBuilderAllFields.from_dict(_all_fields)
        ...
        location_or_builder.additional_properties = d
        return location_or_builder
