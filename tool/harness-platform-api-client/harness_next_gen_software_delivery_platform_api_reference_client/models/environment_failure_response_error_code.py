...
EnvironmentFailureResponseErrorCode = Literal[
    "ABORT_ALL_ALREADY",
    ...
    "UNRESOLVED_EXPRESSIONS_WITH_CONTEXT_ERROR",
...
ENVIRONMENT_FAILURE_RESPONSE_ERROR_CODE_VALUES: set[EnvironmentFailureResponseErrorCode] = {
    "ABORT_ALL_ALREADY",
    "ABORT_ALL_ALREADY_NG",
    "ACCESS_DENIED",
    "ACCOUNT_DISABLED",
...
def check_environment_failure_response_error_code(value: str) -> EnvironmentFailureResponseErrorCode:
    if value in ENVIRONMENT_FAILURE_RESPONSE_ERROR_CODE_VALUES:
        return cast(EnvironmentFailureResponseErrorCode, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {ENVIRONMENT_FAILURE_RESPONSE_ERROR_CODE_VALUES!r}")
