...
T = TypeVar("T", bound="DockerUserNamePassword")


@_attrs_define
class DockerUserNamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        docker_user_name_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        docker_user_name_password.additional_properties = d
        return docker_user_name_password
