...
if TYPE_CHECKING:
    from ..models.delegate_delete_response import DelegateDeleteResponse
    from ..models.response_message import ResponseMessage
    from ..models.rest_response_delegate_delete_response_meta_data import RestResponseDelegateDeleteResponseMetaData


T = TypeVar("T", bound="RestResponseDelegateDeleteResponse")


@_attrs_define
class RestResponseDelegateDeleteResponse:
    """
    Attributes:
        meta_data (RestResponseDelegateDeleteResponseMetaData | Unset):
        resource (DelegateDeleteResponse | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseDelegateDeleteResponseMetaData | Unset = UNSET
    resource: DelegateDeleteResponse | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseDelegateDeleteResponseMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DelegateDeleteResponse.from_dict(_resource)
        ...
        rest_response_delegate_delete_response = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_delegate_delete_response.additional_properties = d
        return rest_response_delegate_delete_response
