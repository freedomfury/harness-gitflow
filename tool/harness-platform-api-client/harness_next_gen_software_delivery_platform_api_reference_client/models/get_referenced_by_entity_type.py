...
GetReferencedByEntityType = Literal[
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
GET_REFERENCED_BY_ENTITY_TYPE_VALUES: set[GetReferencedByEntityType] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_get_referenced_by_entity_type(value: str) -> GetReferencedByEntityType:
    if value in GET_REFERENCED_BY_ENTITY_TYPE_VALUES:
        return cast(GetReferencedByEntityType, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {GET_REFERENCED_BY_ENTITY_TYPE_VALUES!r}")
