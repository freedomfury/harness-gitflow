...
T = TypeVar("T", bound="PageResponseGitSyncError")


@_attrs_define
class PageResponseGitSyncError:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[GitSyncError] | Unset):
    ...
    content: list[GitSyncError] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GitSyncError.from_dict(content_item_data)
        ...
        page_response_git_sync_error = cls(
        ...
        page_response_git_sync_error.additional_properties = d
        return page_response_git_sync_error
