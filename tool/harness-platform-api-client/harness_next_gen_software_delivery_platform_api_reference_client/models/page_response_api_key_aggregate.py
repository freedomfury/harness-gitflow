...
T = TypeVar("T", bound="PageResponseApiKeyAggregate")


@_attrs_define
class PageResponseApiKeyAggregate:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ApiKeyAggregate] | Unset):
    ...
    content: list[ApiKeyAggregate] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ApiKeyAggregate.from_dict(content_item_data)
        ...
        page_response_api_key_aggregate = cls(
        ...
        page_response_api_key_aggregate.additional_properties = d
        return page_response_api_key_aggregate
