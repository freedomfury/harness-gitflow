...
if TYPE_CHECKING:
    ...
    from ..models.update_saml_meta_data_for_saml_sso_id_body_file import UpdateSamlMetaDataForSamlSSOIdBodyFile


T = TypeVar("T", bound="UpdateSamlMetaDataForSamlSSOIdBody")


@_attrs_define
class UpdateSamlMetaDataForSamlSSOIdBody:
    """
    Attributes:
        file (UpdateSamlMetaDataForSamlSSOIdBodyFile | Unset): SAML Metadata input file
        ...
        friendly_saml_name (str | Unset): Friendly name of the app on SAML SSO provider end in Harness
    ...
    file: UpdateSamlMetaDataForSamlSSOIdBodyFile | Unset = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.friendly_saml_name, Unset):
            files.append(("friendlySamlName", (None, str(self.friendly_saml_name).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file: UpdateSamlMetaDataForSamlSSOIdBodyFile | Unset
        if isinstance(_file, Unset):
            file = UNSET
        else:
            file = UpdateSamlMetaDataForSamlSSOIdBodyFile.from_dict(_file)
        ...
        update_saml_meta_data_for_saml_sso_id_body = cls(
            file=file,
        ...
        update_saml_meta_data_for_saml_sso_id_body.additional_properties = d
        return update_saml_meta_data_for_saml_sso_id_body
