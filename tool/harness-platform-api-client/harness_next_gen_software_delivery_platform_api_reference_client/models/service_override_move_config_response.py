...
from ..models.service_override_move_config_response_type import (
    ServiceOverrideMoveConfigResponseType,
    check_service_override_move_config_response_type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ServiceOverrideMoveConfigResponse")


@_attrs_define
class ServiceOverrideMoveConfigResponse:
    """Tells us if the move config was successful or not

    Attributes:
        environment_ref (str): Environment Reference for the Entity.
        type_ (ServiceOverrideMoveConfigResponseType): Type of the override which is based on source of overrides
    ...
    environment_ref: str
    type_: ServiceOverrideMoveConfigResponseType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_service_override_move_config_response_type(d.pop("type"))
        ...
        service_override_move_config_response = cls(
        ...
        service_override_move_config_response.additional_properties = d
        return service_override_move_config_response
