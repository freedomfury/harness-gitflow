...
T = TypeVar("T", bound="PageResponseKey")


@_attrs_define
class PageResponseKey:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = Key.from_dict(content_item_data)
        ...
        page_response_key.additional_properties = d
        return page_response_key
