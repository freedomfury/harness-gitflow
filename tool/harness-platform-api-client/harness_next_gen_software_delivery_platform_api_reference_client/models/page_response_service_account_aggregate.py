...
T = TypeVar("T", bound="PageResponseServiceAccountAggregate")


@_attrs_define
class PageResponseServiceAccountAggregate:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ServiceAccountAggregate] | Unset):
    ...
    content: list[ServiceAccountAggregate] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ServiceAccountAggregate.from_dict(content_item_data)
        ...
        page_response_service_account_aggregate = cls(
        ...
        page_response_service_account_aggregate.additional_properties = d
        return page_response_service_account_aggregate
