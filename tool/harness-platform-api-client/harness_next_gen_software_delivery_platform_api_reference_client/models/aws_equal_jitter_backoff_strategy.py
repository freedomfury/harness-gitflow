...
T = TypeVar("T", bound="AwsEqualJitterBackoffStrategy")


@_attrs_define
class AwsEqualJitterBackoffStrategy:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aws_equal_jitter_backoff_strategy = cls(
            base_delay=base_delay,
            max_backoff_time=max_backoff_time,
            retry_count=retry_count,
        )

        aws_equal_jitter_backoff_strategy.additional_properties = d
        return aws_equal_jitter_backoff_strategy
