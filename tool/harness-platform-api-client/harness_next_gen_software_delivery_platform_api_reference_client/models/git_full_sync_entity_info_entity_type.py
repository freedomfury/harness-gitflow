...
GitFullSyncEntityInfoEntityType = Literal[
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
GIT_FULL_SYNC_ENTITY_INFO_ENTITY_TYPE_VALUES: set[GitFullSyncEntityInfoEntityType] = {
    "Action",
    "AIEvaluation",
    "AIExperiment",
    "AiVerify",
...
def check_git_full_sync_entity_info_entity_type(value: str) -> GitFullSyncEntityInfoEntityType:
    if value in GIT_FULL_SYNC_ENTITY_INFO_ENTITY_TYPE_VALUES:
        return cast(GitFullSyncEntityInfoEntityType, value)
    raise TypeError(f"Unexpected value {value!r}. Expected one of {GIT_FULL_SYNC_ENTITY_INFO_ENTITY_TYPE_VALUES!r}")
