...
T = TypeVar("T", bound="HttpHelmUsernamePassword")


@_attrs_define
class HttpHelmUsernamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        http_helm_username_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        http_helm_username_password.additional_properties = d
        return http_helm_username_password
