...
if TYPE_CHECKING:
    from ..models.git_full_sync_entity_info import GitFullSyncEntityInfo


T = TypeVar("T", bound="PageResponseGitFullSyncEntityInfo")


@_attrs_define
class PageResponseGitFullSyncEntityInfo:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[GitFullSyncEntityInfo] | Unset):
    ...
    content: list[GitFullSyncEntityInfo] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GitFullSyncEntityInfo.from_dict(content_item_data)
        ...
        page_response_git_full_sync_entity_info = cls(
        ...
        page_response_git_full_sync_entity_info.additional_properties = d
        return page_response_git_full_sync_entity_info
