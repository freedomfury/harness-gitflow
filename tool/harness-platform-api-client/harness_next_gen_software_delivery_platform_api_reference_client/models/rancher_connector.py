...
if TYPE_CHECKING:
    from ..models.rancher_connector_config import RancherConnectorConfig


T = TypeVar("T", bound="RancherConnector")
...
class RancherConnector:
    ...
    Attributes:
        ...
        credential (RancherConnectorConfig | Unset): This contains rancher connector config details
    """

    connector_type: str
    delegate_selectors: list[str] | Unset = UNSET
    ignore_test_connection: bool | Unset = UNSET
    credential: RancherConnectorConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        credential: RancherConnectorConfig | Unset
        if isinstance(_credential, Unset):
            credential = UNSET
        else:
            credential = RancherConnectorConfig.from_dict(_credential)

        rancher_connector = cls(
        ...
        rancher_connector.additional_properties = d
        return rancher_connector
