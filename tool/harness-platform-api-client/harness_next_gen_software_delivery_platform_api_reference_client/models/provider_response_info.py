...
T = TypeVar("T", bound="ProviderResponseInfo")


@_attrs_define
class ProviderResponseInfo:
    """
    Attributes:
        type_ (str):
        domain (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_response_info.additional_properties = d
        return provider_response_info
