...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_delegate_group_listing_meta_data import RestResponseDelegateGroupListingMetaData


T = TypeVar("T", bound="RestResponseDelegateGroupListing")


@_attrs_define
class RestResponseDelegateGroupListing:
    """
    Attributes:
        meta_data (RestResponseDelegateGroupListingMetaData | Unset):
        resource (DelegateGroupListing | Unset):
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseDelegateGroupListingMetaData | Unset = UNSET
    resource: DelegateGroupListing | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseDelegateGroupListingMetaData.from_dict(_meta_data)
        ...
        if isinstance(_resource, Unset):
            ...
            resource = DelegateGroupListing.from_dict(_resource)
        ...
        rest_response_delegate_group_listing = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_delegate_group_listing.additional_properties = d
        return rest_response_delegate_group_listing
