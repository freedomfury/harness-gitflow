...
T = TypeVar("T", bound="RollbackResponseDTO")
...
class RollbackResponseDTO:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rollback_response_dto.additional_properties = d
        return rollback_response_dto
