...
T = TypeVar("T", bound="PageResponseClusterResponse")


@_attrs_define
class PageResponseClusterResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[ClusterResponse] | Unset):
    ...
    content: list[ClusterResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = ClusterResponse.from_dict(content_item_data)
        ...
        page_response_cluster_response = cls(
        ...
        page_response_cluster_response.additional_properties = d
        return page_response_cluster_response
