...
if TYPE_CHECKING:
    from ..models.terraform_cloud_credential import TerraformCloudCredential


T = TypeVar("T", bound="TerraformCloudConnector")
...
class TerraformCloudConnector:
    ...
    Attributes:
        ...
        credential (TerraformCloudCredential): This contains Terraform Cloud connector credentials
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        terraform_cloud_url = self.terraform_cloud_url
        ...
        field_dict.update(
            {
                ...
                "terraformCloudUrl": terraform_cloud_url,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        terraform_cloud_url = d.pop("terraformCloudUrl")

        credential = TerraformCloudCredential.from_dict(d.pop("credential"))
        ...
        terraform_cloud_connector.additional_properties = d
        return terraform_cloud_connector
