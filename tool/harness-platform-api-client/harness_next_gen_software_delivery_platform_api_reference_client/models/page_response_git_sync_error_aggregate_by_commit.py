...
if TYPE_CHECKING:
    from ..models.git_sync_error_aggregate_by_commit import GitSyncErrorAggregateByCommit


T = TypeVar("T", bound="PageResponseGitSyncErrorAggregateByCommit")


@_attrs_define
class PageResponseGitSyncErrorAggregateByCommit:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[GitSyncErrorAggregateByCommit] | Unset):
    ...
    content: list[GitSyncErrorAggregateByCommit] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = GitSyncErrorAggregateByCommit.from_dict(content_item_data)
        ...
        page_response_git_sync_error_aggregate_by_commit = cls(
        ...
        page_response_git_sync_error_aggregate_by_commit.additional_properties = d
        return page_response_git_sync_error_aggregate_by_commit
