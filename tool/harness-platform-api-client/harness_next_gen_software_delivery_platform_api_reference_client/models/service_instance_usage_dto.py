...
from ..models.service_instance_usage_dto_cd_license_type import (
    ServiceInstanceUsageDTOCdLicenseType,
    check_service_instance_usage_dto_cd_license_type,
)
...
T = TypeVar("T", bound="ServiceInstanceUsageDTO")


@_attrs_define
class ServiceInstanceUsageDTO:
    """
    Attributes:
        ...
        cd_license_type (ServiceInstanceUsageDTOCdLicenseType | Unset):
    """
    ...
    cd_license_type: ServiceInstanceUsageDTOCdLicenseType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cd_license_type, Unset):
            ...
            cd_license_type = check_service_instance_usage_dto_cd_license_type(_cd_license_type)

        service_instance_usage_dto = cls(
        ...
        service_instance_usage_dto.additional_properties = d
        return service_instance_usage_dto
