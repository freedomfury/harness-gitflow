...
from ..models.override_request_type import OverrideRequestType, check_override_request_type
from ..types import UNSET, Unset

T = TypeVar("T", bound="OverrideRequest")


@_attrs_define
class OverrideRequest:
    """This is the Override Request details defined in Harness

    Attributes:
        environment_ref (str): Environment Reference for the Entity.
        type_ (OverrideRequestType): Type of the override which is based on source of overrides
        identifier (str | Unset): Identifier of the Override Entity.
        ...
        yaml (str | Unset): Yaml for overrides, containing overriding fields like manifests, variables, config files
    """

    environment_ref: str
    type_: OverrideRequestType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = check_override_request_type(d.pop("type"))
        ...
        override_request.additional_properties = d
