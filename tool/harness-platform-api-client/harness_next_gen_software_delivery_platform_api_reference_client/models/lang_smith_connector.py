...
if TYPE_CHECKING:
    from ..models.lang_smith_authentication_dto import LangSmithAuthenticationDTO


T = TypeVar("T", bound="LangSmithConnector")
...
class LangSmithConnector:
    ...
    Attributes:
        connector_type (str):
        base_url (str):
        auth (LangSmithAuthenticationDTO | Unset): This entity contains the details for LangSmith Authentication
    ...
    connector_type: str
    base_url: str
    auth: LangSmithAuthenticationDTO | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lang_smith_connector.additional_properties = d
        return lang_smith_connector
