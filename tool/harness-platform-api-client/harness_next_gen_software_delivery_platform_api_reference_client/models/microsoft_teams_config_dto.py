...
T = TypeVar("T", bound="MicrosoftTeamsConfigDTO")


@_attrs_define
class MicrosoftTeamsConfigDTO:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        microsoft_teams_webhook_url = d.pop("microsoftTeamsWebhookUrl")
        ...
        microsoft_teams_config_dto = cls(
            microsoft_teams_webhook_url=microsoft_teams_webhook_url,
            type_=type_,
        )

        microsoft_teams_config_dto.additional_properties = d
        return microsoft_teams_config_dto
