...
T = TypeVar("T", bound="BitbucketServerProviderRequestInfo")


@_attrs_define
class BitbucketServerProviderRequestInfo:
    """
    Attributes:
        type_ (str):
        domain (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bitbucket_server_provider_request_info = cls(
            type_=type_,
            domain=domain,
        ...
        bitbucket_server_provider_request_info.additional_properties = d
        return bitbucket_server_provider_request_info
