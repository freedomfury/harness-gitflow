...
T = TypeVar("T", bound="KubernetesUserNamePassword")


@_attrs_define
class KubernetesUserNamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kubernetes_user_name_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        kubernetes_user_name_password.additional_properties = d
        return kubernetes_user_name_password
