...
T = TypeVar("T", bound="PageResponseVariableResponseDTO")


@_attrs_define
class PageResponseVariableResponseDTO:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[VariableResponseDTO] | Unset):
    ...
    content: list[VariableResponseDTO] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = VariableResponseDTO.from_dict(content_item_data)
        ...
        page_response_variable_response_dto = cls(
        ...
        page_response_variable_response_dto.additional_properties = d
        return page_response_variable_response_dto
