...
if TYPE_CHECKING:
    ...
    from ..models.rest_response_user_group_meta_data import RestResponseUserGroupMetaData
    from ..models.user_group import UserGroup


T = TypeVar("T", bound="RestResponseUserGroup")


@_attrs_define
class RestResponseUserGroup:
    """
    Attributes:
        meta_data (RestResponseUserGroupMetaData | Unset):
        resource (UserGroup | Unset): User Group details defined in Harness.
        response_messages (list[ResponseMessage] | Unset):
    """

    meta_data: RestResponseUserGroupMetaData | Unset = UNSET
    resource: UserGroup | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta_data, Unset):
            ...
            meta_data = RestResponseUserGroupMetaData.from_dict(_meta_data)

        _resource = d.pop("resource", UNSET)
        resource: UserGroup | Unset
        if isinstance(_resource, Unset):
            resource = UNSET
        else:
            resource = UserGroup.from_dict(_resource)
        ...
        rest_response_user_group = cls(
            meta_data=meta_data,
            resource=resource,
            response_messages=response_messages,
        )

        rest_response_user_group.additional_properties = d
        return rest_response_user_group
