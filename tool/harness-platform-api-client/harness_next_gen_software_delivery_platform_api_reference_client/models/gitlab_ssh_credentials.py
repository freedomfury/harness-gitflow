...
T = TypeVar("T", bound="GitlabSshCredentials")


@_attrs_define
class GitlabSshCredentials:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gitlab_ssh_credentials = cls(
            ssh_key_ref=ssh_key_ref,
        )

        gitlab_ssh_credentials.additional_properties = d
        return gitlab_ssh_credentials
