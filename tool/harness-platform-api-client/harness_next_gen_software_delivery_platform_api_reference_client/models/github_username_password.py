...
T = TypeVar("T", bound="GithubUsernamePassword")


@_attrs_define
class GithubUsernamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_username_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        github_username_password.additional_properties = d
        return github_username_password
