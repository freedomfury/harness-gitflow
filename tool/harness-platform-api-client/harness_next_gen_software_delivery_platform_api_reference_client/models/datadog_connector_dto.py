...
T = TypeVar("T", bound="DatadogConnectorDTO")


@_attrs_define
class DatadogConnectorDTO:
    """
    Attributes:
        connector_type (str):
        url (str):
        ...
        field_dict.update(
            {
                ...
                "url": url,
                "applicationKeyRef": application_key_ref,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        application_key_ref = d.pop("applicationKeyRef")
        ...
        datadog_connector_dto = cls(
            connector_type=connector_type,
            url=url,
            application_key_ref=application_key_ref,
            api_key_ref=api_key_ref,
            delegate_selectors=delegate_selectors,
            ignore_test_connection=ignore_test_connection,
        )

        datadog_connector_dto.additional_properties = d
        return datadog_connector_dto
