...
T = TypeVar("T", bound="OciHelmUsernamePassword")


@_attrs_define
class OciHelmUsernamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        oci_helm_username_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        oci_helm_username_password.additional_properties = d
        return oci_helm_username_password
