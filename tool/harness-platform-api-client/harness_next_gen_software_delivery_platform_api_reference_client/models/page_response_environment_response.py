...
T = TypeVar("T", bound="PageResponseEnvironmentResponse")


@_attrs_define
class PageResponseEnvironmentResponse:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[EnvironmentResponse] | Unset):
    ...
    content: list[EnvironmentResponse] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = EnvironmentResponse.from_dict(content_item_data)
        ...
        page_response_environment_response = cls(
        ...
        page_response_environment_response.additional_properties = d
        return page_response_environment_response
