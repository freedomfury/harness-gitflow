...
T = TypeVar("T", bound="AwsCodeCommitSecretKeyAccessKey")


@_attrs_define
class AwsCodeCommitSecretKeyAccessKey:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aws_code_commit_secret_key_access_key = cls(
            secret_key_ref=secret_key_ref,
            access_key=access_key,
            access_key_ref=access_key_ref,
        )

        aws_code_commit_secret_key_access_key.additional_properties = d
        return aws_code_commit_secret_key_access_key
