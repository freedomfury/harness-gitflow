...
if TYPE_CHECKING:
    from ..models.entity_setup_usage import EntitySetupUsage


T = TypeVar("T", bound="PageResponseEntitySetupUsage")


@_attrs_define
class PageResponseEntitySetupUsage:
    """
    Attributes:
        ...
        page_size (int | Unset):
        content (list[EntitySetupUsage] | Unset):
    ...
    content: list[EntitySetupUsage] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _content is not UNSET:
            ...
            for content_item_data in _content:
                content_item = EntitySetupUsage.from_dict(content_item_data)
        ...
        page_response_entity_setup_usage = cls(
        ...
        page_response_entity_setup_usage.additional_properties = d
        return page_response_entity_setup_usage
