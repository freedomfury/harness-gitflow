...
T = TypeVar("T", bound="JiraUserNamePassword")


@_attrs_define
class JiraUserNamePassword:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jira_user_name_password = cls(
            password_ref=password_ref,
            username=username,
            username_ref=username_ref,
        )

        jira_user_name_password.additional_properties = d
        return jira_user_name_password
