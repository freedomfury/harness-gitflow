...
from ...models.get_service_access_list_type import GetServiceAccessListType
from ...models.response_dto_list_service_response import ResponseDTOListServiceResponse
...
def _get_kwargs(
    *,
    ...
    params["deploymentMetadataYaml"] = deployment_metadata_yaml
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOListServiceResponse:
    ...
    response_default = ResponseDTOListServiceResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOListServiceResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        ...
        deployment_metadata_yaml=deployment_metadata_yaml,
...
def sync(
    *,
    ...
    deployment_metadata_yaml: str | Unset = UNSET,
    include_all_services_accessible_at_scope: bool | Unset = False,
) -> Error | Failure | ResponseDTOListServiceResponse | None:
    """Gets Service Access list
