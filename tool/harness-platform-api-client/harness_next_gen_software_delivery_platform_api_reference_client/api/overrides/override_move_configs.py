...
from ...models.override_move_configs_move_config_type import (
    OverrideMoveConfigsMoveConfigType,
)
from ...models.override_move_configs_service_overrides_type import (
...
def _get_kwargs(
    *,
    ...
    move_config_type: OverrideMoveConfigsMoveConfigType | Unset = UNSET,
    environment_ref: str | Unset = UNSET,
    service_ref: str | Unset = UNSET,
    infra_identifier: str | Unset = UNSET,
    service_overrides_type: OverrideMoveConfigsServiceOverridesType | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    """Move Override YAML from inline to remote or remote to inline
    ...
    Args:
        ...
        move_config_type (OverrideMoveConfigsMoveConfigType | Unset):
        environment_ref (str | Unset):
        service_ref (str | Unset):
        infra_identifier (str | Unset):
        service_overrides_type (OverrideMoveConfigsServiceOverridesType | Unset):
