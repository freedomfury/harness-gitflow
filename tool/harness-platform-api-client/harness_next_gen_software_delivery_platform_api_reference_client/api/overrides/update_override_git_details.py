...
from ...models.update_override_git_details_service_overrides_type import (
...
def _get_kwargs(
    *,
    ...
    service_overrides_type: UpdateOverrideGitDetailsServiceOverridesType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/overrides/update-git-metadata",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Update git-metadata in remote Override Entity

     Update git-metadata in remote Override and returns the identifier of updated Override
    ...
    Args:
        ...
        service_overrides_type (UpdateOverrideGitDetailsServiceOverridesType | Unset):
