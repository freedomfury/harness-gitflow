...
from ...models.secret_request_wrapper import SecretRequestWrapper
...
def _get_kwargs(
    identifier: str,
    *,
    body: SecretRequestWrapper | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v2/secrets/{identifier}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (SecretRequestWrapper | Unset):
