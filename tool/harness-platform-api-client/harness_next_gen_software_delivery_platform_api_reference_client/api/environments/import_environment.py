...
from ...models.response_dto_environment_import_response_details import ResponseDTOEnvironmentImportResponseDetails
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOEnvironmentImportResponseDetails:
    ...
    response_default = ResponseDTOEnvironmentImportResponseDetails.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOEnvironmentImportResponseDetails]:
    return Response(
...
def sync(
    *,
    ...
    is_force_import: bool | Unset = False,
    is_harness_code_repo: bool | Unset = UNSET,
) -> Error | Failure | ResponseDTOEnvironmentImportResponseDetails | None:
    """Import and Create Environment from Git Repository
