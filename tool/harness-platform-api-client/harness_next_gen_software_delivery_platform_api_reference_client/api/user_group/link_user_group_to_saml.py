...
from ...models.saml_link_group_request import SamlLinkGroupRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/user-groups/{user_group_id}/link/saml/{saml_id}".format(
            user_group_id=quote(str(user_group_id), safe=""),
            saml_id=quote(str(saml_id), safe=""),
        ),
        "params": params,
    }
