...
from ...models.get_user_group_list_filter_type import GetUserGroupListFilterType
...
def _get_kwargs(
    *,
    ...
    filter_type: GetUserGroupListFilterType | Unset = "EXCLUDE_INHERITED_GROUPS",
    sso_group_id: list[str] | Unset = UNSET,
    ...
    json_sso_group_id: list[str] | Unset = UNSET
    if not isinstance(sso_group_id, Unset):
        json_sso_group_id = sso_group_id

    params["ssoGroupId"] = json_sso_group_id
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        filter_type (GetUserGroupListFilterType | Unset):  Default: 'EXCLUDE_INHERITED_GROUPS'.
        sso_group_id (list[str] | Unset):
