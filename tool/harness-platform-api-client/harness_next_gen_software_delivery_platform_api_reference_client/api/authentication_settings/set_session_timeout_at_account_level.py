...
from ...models.session_timeout_settings import SessionTimeoutSettings
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: SessionTimeoutSettings,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/authentication-settings/session-timeout-account-level",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        account_identifier (str):
        body (SessionTimeoutSettings): This contains the information about the session timeout for
            this account in Harness.
