...
from ...models.response_dto_page_response_git_sync_error_aggregate_by_commit import (
...
def _get_kwargs(
    *,
    ...
    number_of_errors_in_summary: int | Unset = 5,
) -> dict[str, Any]:
    ...
    params["numberOfErrorsInSummary"] = number_of_errors_in_summary

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/git-sync-errors/aggregate",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOPageResponseGitSyncErrorAggregateByCommit:
    ...
    response_default = ResponseDTOPageResponseGitSyncErrorAggregateByCommit.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOPageResponseGitSyncErrorAggregateByCommit]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        number_of_errors_in_summary (int | Unset):  Default: 5.
    ...
    kwargs = _get_kwargs(
        ...
        number_of_errors_in_summary=number_of_errors_in_summary,
    )
...
def sync(
    *,
    ...
    get_default_from_other_repo: bool | Unset = UNSET,
    number_of_errors_in_summary: int | Unset = 5,
) -> Error | Failure | ResponseDTOPageResponseGitSyncErrorAggregateByCommit | None:
    """Lists Git to Harness Errors grouped by Commits for the given scope, Repo and Branch
