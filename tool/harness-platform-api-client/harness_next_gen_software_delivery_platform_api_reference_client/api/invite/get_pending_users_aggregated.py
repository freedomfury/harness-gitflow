...
from ...models.response_dto_page_response_invite import ResponseDTOPageResponseInvite
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOPageResponseInvite:
    ...
    response_default = ResponseDTOPageResponseInvite.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOPageResponseInvite]:
    return Response(
...
def sync(
    *,
    ...
    sort_orders: list[SortOrder] | Unset = UNSET,
    page_token: str | Unset = UNSET,
) -> Error | Failure | ResponseDTOPageResponseInvite | None:
    """Get pending users
