...
from ...models.create_connector_store_type import CreateConnectorStoreType
...
def _get_kwargs(
    *,
    ...
    store_type: CreateConnectorStoreType | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        store_type (CreateConnectorStoreType | Unset):
        repo_name (str | Unset):
        is_harness_code_repo (bool | Unset):
        body (Connector): This is the view of Connector entity as defined in Harness.
