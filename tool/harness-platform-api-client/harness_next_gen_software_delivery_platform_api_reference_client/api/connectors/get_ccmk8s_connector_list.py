...
from ...models.response_dto_page_response_ccm_k8s_connector_response import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOPageResponseCcmK8SConnectorResponse:
    ...
    response_default = ResponseDTOPageResponseCcmK8SConnectorResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOPageResponseCcmK8SConnectorResponse]:
    return Response(
...
def sync(
    *,
    ...
    sort_orders: list[SortOrder] | Unset = UNSET,
    page_token: str | Unset = UNSET,
) -> Error | Failure | ResponseDTOPageResponseCcmK8SConnectorResponse | None:
    """Fetches the list of CCM K8S Connectors corresponding to the request's filter criteria.
