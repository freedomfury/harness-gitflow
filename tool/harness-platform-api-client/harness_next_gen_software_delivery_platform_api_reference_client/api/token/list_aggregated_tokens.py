...
from ...models.list_aggregated_tokens_api_key_type import (
    ListAggregatedTokensApiKeyType,
)
from ...models.response_dto_page_response_token_aggregate import ResponseDTOPageResponseTokenAggregate
...
def _get_kwargs(
    *,
    ...
    api_key_type: ListAggregatedTokensApiKeyType,
    parent_identifier: str | Unset = UNSET,
    api_key_identifier: str | Unset = UNSET,
    ...
    include_only_active_tokens: bool | Unset = UNSET,
) -> dict[str, Any]:
    ...
    params["includeOnlyActiveTokens"] = include_only_active_tokens
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | ResponseDTOPageResponseTokenAggregate:
    ...
    response_default = ResponseDTOPageResponseTokenAggregate.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | ResponseDTOPageResponseTokenAggregate]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        include_only_active_tokens (bool | Unset):
    ...
    kwargs = _get_kwargs(
        ...
        include_only_active_tokens=include_only_active_tokens,
    )
...
def sync(
    *,
    ...
    search_term: str | Unset = UNSET,
    include_only_active_tokens: bool | Unset = UNSET,
) -> Error | Failure | ResponseDTOPageResponseTokenAggregate | None:
    """List all Tokens
