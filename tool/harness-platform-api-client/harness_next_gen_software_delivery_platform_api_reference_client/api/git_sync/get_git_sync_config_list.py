...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Error | Failure | list[GitSyncConfig]:
    ...
    for response_default_item_data in _response_default:
        response_default_item = GitSyncConfig.from_dict(response_default_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | Failure | list[GitSyncConfig]]:
    return Response(
...
def sync(
    *,
    ...
    org_identifier: str | Unset = UNSET,
    account_identifier: str,
) -> Error | Failure | list[GitSyncConfig] | None:
    """Lists Git Sync Config for the given scope
