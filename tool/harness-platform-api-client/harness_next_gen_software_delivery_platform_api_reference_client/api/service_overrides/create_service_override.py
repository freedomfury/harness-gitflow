...
from ...models.service_override_request_v2 import ServiceOverrideRequestV2
from ...types import UNSET, Response


def _get_kwargs(
    *,
    body: ServiceOverrideRequestV2,
...
def sync_detailed(
    *,
    ...
    Args:
        account_identifier (str):
        body (ServiceOverrideRequestV2): This is the Service Override Request entity defined in
            Harness
