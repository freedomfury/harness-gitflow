...
│   ├── sdk-generation.md            how to regenerate SDKs (CLI builds itself at runtime)
...
harness-cli --help                 # 225 commands, built at runtime from the SDKs
...
| CLI (225 commands) | `tool/harness-cli/` | [`tool/harness-cli/harness_cli/loader.py`](tool/harness-cli/harness_cli/loader.py) (built at runtime from the SDKs) |
| CLI custom commands (`run`, `logs`, `ng-file-store`) | `tool/harness-cli/harness_cli/commands/` | hand-written |
